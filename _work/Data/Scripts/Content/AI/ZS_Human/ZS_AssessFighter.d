...
//	ZS_AssessFighter
//	================
//	Wird ausschlieЯlich aus:
//
//	- B_AssessFighter
//
//	heraus aufgerufen. Dort wurde festgestellt, daЯ die gezogene
//	Waffe des SCs eine Bedrohung darstellt!  Diese Funktion muЯ also
//	auf diese echte Bedrohung reagieren. Was passiert:
//
//	1.	schon mal vom SC besiegt	->	Zurьckweichen
//	2.	NSC ist WACHE oder BOSS		->	Aufforderung Waffe/Magie
//										wegzustecken 	
//	3.	NSC ist ARBEITER
//		- stдrker als SC			-> 	Aufforderung Waffe/Magie
//										wegzustecken
//		- schwдcher als SC			-> 	Zurьckweichen
//
...
{	
	...
	//-------- Wird der NSC zurьckweichen ? --------
	if (	self.aivar[AIV_WASDEFEATEDBYSC] 					||		// Wurde NSC schon mal besiegt, oder...
			(C_NpcIsWorker(self) && C_AmIWeaker(self, other))		)	// ...ist NSC ein schwдcherer WORKER ?
	{
	...
	{
		Npc_PercEnable	(self, 	PERC_ASSESSREMOVEWEAPON	,	B_AssessRemoveWeapon);	// Wahrnehmung erst hier einschalten, damit ein zurьckweichender NSC nicht auf ein schnelles Waffenwegstecken des SCs reagiert!
