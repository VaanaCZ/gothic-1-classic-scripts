...
//	2.	tempAttitьde auf hostile
//	3.	weglaufen bis genьgend Distanz zum Gegner
...
{	
	...
	//B_DropWeapon		(self);						// aus Gamedesign-Grьnden entfernt
...
func int ZS_Flee_Loop ()
{
	...
	else if (Npc_GetDistToNpc(self,	other) > HAI_DIST_ABORT_FLEE)		// Gegner noch nдher als 20m?
	{																// ...nein...
		PrintDebugNpc	(PD_ZS_CHECK,	"...Gegner weit genug weg -> Flucht abbrechen!");			
		return			LOOP_END;									// 
	}
	
	//-------- Gegner noch kampffдhig? --------
