...
//	ZS_AssessMurder
//	===============
//	Wird ausschlieЯlich durch
//
//	- PERC_ASSESSMURDER
//
//	angesprungen. Folgende Voraussetzungen mьssen erfьllt sein:
//
//	- keine!
//
//	Macht folgendes:
...
//		->	Wachen, deren Schьtzlinge besiegt wurden 	-> ZS_ProclaimAndPunish
//		->	war das Opfer ein Freund					-> B_AssessEnemy
//		->	Wenn ANGRY/HOSTILE zum Mordopfer 			-> spцttischer Kommentar
//////////////////////////////////////////////////////////////////////////
...
{	
	...
	if (Npc_CanSeeNpcFreeLOS(self,other) || Npc_CanSeeNpcFreeLOS(self,victim))
	{
		...
		//-------- Schьtzling einer Wache wurde umgehauen ! --------
		...
		//-------- fьhrte Mordbewertung in B_AssessAndMemorize zu HOSTILE ? --------
