func void B_Stop	()
{
	...
	if (Npc_GetDistToNpc(self, other)  < PERC_DIST_WATCHFIGHT)
	{
		...
		AI_StandUp		( self);
		//AI_SetWalkmode( self, NPC_WALK); --> falls sie doch mal rennen sollten, muЯ es natьrlich auch wieder abgeschaltet werden
...
func void ZS_GotoFight	()
{
	...
	//AI_SetWalkmode	(self, NPC_RUN); --> wдre zwar schцner, die Nscґs zum Kampf rennen zu lassen, aber dann rennen sie zu weit rein
