...
//
//	1.	Ist der NSC stдrkere Wache/Boss/Arbeiter		-> Angriff
//	2.	Ist der NSC schwдchere/besiegte Wache/Boss		-> Wachen rufen -> Angriff
//	3.	Ist der NSC ein schwдcherer/besiegter Arbeiter	-> Wachen rufen -> Flucht
//
//////////////////////////////////////////////////////////////////////////
//	ToDo
//	----
...
{		
	...
	||	C_NpcIsBoss(self)
	||	(self.npctype==NPCTYPE_FRIEND)	//solche dьrfen niemals fliehen!
	{
		//---- NSC ruft zusдtzlich Hilfe ! ----
