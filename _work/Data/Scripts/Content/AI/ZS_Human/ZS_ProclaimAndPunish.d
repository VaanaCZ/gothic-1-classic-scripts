...
//	- ZS_AssessMurder
//
//	Folgende Voraussetzungen mьssen erfьllt sein:
//
//	- zu Bestrafender muЯ der Spiele sein ('hero' wird verwendet!)
//	- NSC muЯ bereits eine passende Waffe gezogen haben!
//
//	Macht folgendes:
//	1.	Falls eine Wache (kein Todfeind) schon mal vom 'hero' besiegt wurde
//		->	ZS_TurnAway
//	2.	Zum Ziel 'hero' hinlaufen, falls zu weit weg
//	3.	Den Grund des Angriffs verkьnden
//	4.	Angreifen
//////////////////////////////////////////////////////////////////////////
...
func void ZS_ProclaimAndPunish_End ()
{
	...
	// - hat Schьtzling/Freund des NSCs getцtet	-> $YouKilledOneOfUs
	// - greift Schьtzling an					-> $YouAttackedMyCharge
	// - permHostile durch Gildentabelle		-> $DieMortalEnemy
	if (Npc_WasInState(self, ZS_AssessEnemy))
	{
		//-------- SC hat Freund getцtet ! --------
		var int murder_news;
	...
	else
	{
		...
		//-------- SC greift Schьtzling einer Wache an ! --------
		else
		{
