...
//	gewarnt.
//	- self:		Empfдnger der Warnung
//	- victim:	Sender der Warnung
//	- other:	der Dritte, vor dem gewarnt wird
//
//	Folgende Fдlle kцnnen zu einer Warnung zwischen Menschen fьhren:
...
func void ZS_AssessWarn ()
{
	...
	// ----------------- MH: fьr ItemSchweine (EBR-Haus. Lares, etc) ------------------ 
...
func void ZS_AssessWarn_End ()
{
	...
	if (Npc_CanSeeNpcFreeLOS(self, other))
	{
		...
		else if (Npc_HasNews(self, NEWS_MURDER, other, victim) && Npc_GetGuildAttitude	( self, victim) == ATT_FRIENDLY)
		{
			...
			// JP: Hier gab es kein Svm, ich habe da mal noch eins eingefьgt, damit wenigstens klar ist, da wird der Sc angegriffen
			Npc_GetTarget	(self);
			AI_StartState	(self, ZS_AssessEnemy, 0, "");
		}
		else
