func void B_MoveMob ()
// 5.5.00 Hier muЯ noch die Abfrage auf Tьren rein, wenn sie fertig ist
{
	...
	//-------- blockierendes MOB eine Tьre --------
	if (Hlp_StrCmp			(door,	"DOOR"))
	{
		PrintDebugNpc		(PD_ZS_CHECK, "...mob is a door!");

		if (self.aivar[AIV_MOVINGMOB] == 0)							// versucht der NSC bereits die Tьr zu цffnen?
		{
			...
			AI_UseMob		(self,	door, 1);						// falls sie geschlossen ist -> цffnen		
		}
		else
		{
