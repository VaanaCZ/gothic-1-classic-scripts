...
//	- ZS_AssessMurder		(wenn hostile zum Mцrder)
//	- ZS_AssessSurprise		(wenn hostile zum Zurьckverwandelten)
...
//
//	Die primдre Aufgabe von B_AssessEnemy ist es, festzustellen
...
func void B_AssessEnemy()
{
	...
	if (Npc_CanSeeNpcFreeLOS( self, other))
	{
		...
		if ( C_NpcIsHuman(other) )
		{
			...
			//-------- Important-Info ! --------
			if (self.aivar[AIV_TALKBEFOREATTACK])							// Hat der NSC eine "letzte Nachricht" fьr den Feind?
			{	
			...
			{	
				...
				return;														//... dann verzeihen wir ihm natьrlich -> Abbruch des Checks
			};
		
			//-------- Also doch ein ganz ordinдrer Feind! --------
			B_FullStop			(self);
			AI_StartState 		(self, 	ZS_AssessEnemy,	0,	"");
		}		
	
		//######## ...dann muЯ der Enemy ein MONSTER sein ########
		else
		{
