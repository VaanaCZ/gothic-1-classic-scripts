...
/*
B_SpreadNews <Erzдhler-NSC> <InfoQuelle> <Tдter-SC> <Ereignis ID> <Opfer> 
Fьr jeden NSC jeder Gilde, die zur Gilde des <Erzдhler-NSCs> befreundet ist
	Wenn NSC =|= Erzдhler-NSC, dann 	UND NICHT WITNESS!!!
B_AssessAndMemorize <NSC> <GOSSIP> <Tдter-SC> <Ereignis ID> <Opfer/Besitzer> 
*/
{
	...
	if (murder_news	> 0)
	{
		...
		if (defeat_news > 0)
		{
			...
			if (B_CompareNpcInstance (murder_news_victim,defeat_news_victim))
			{
				...
				{
					PrintDebugNpc 	(PD_ZS_CHECK, "...und gleicher Tдter");
