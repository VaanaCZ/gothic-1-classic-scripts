...
//	B_FillQuiver
//	============
//	Fьllt den Kцcher des NSCs 'slf' auf 20 auf. Diese Funktion geht davon
//	aus, daЯ der NSC die entsprechende Fernkampfwaffe in der Hand hдlt.
//////////////////////////////////////////////////////////////////////////
...
//	-> gibt TRUE zurьck, wenn Waffe angelegt werden konnte, sonst FALSE
//////////////////////////////////////////////////////////////////////////
...
//	B_SelectWeapon
//	==============
//	Wдhlt fьr den NSC 'slf' unter Berьcksichtigung der Kampfsitution
//	die jeweils passende Waffe aus.
//	Diese Funktion wird wдhrend der ZS_Attack alle 3 Sekunden
...
func void B_SelectWeapon(var C_NPC slf, var C_NPC oth)
{
	...
	//folgende Zauber sind fьr NSCs mцglich:
	// - Firebolt/Thunderbolt/BreathOfDeath	schnelles GeschoЯ			
	// - Fireball/Thunderball				Aufblas-GeschoЯ
	...
	if ( (Npc_GetDistToNpc(slf,oth)<HAI_DIST_MELEE) && (slf.fight_tactic!=FAI_HUMAN_RANGED) )
	{
		...
		// ---- ...sonst mit den Fдusten kдmpfen ---- 								
		PrintDebugNpc			(PD_ZS_CHECK, "...keine Nahkampfwaffe im Inv -> Faustkampf!");
		AI_ReadyMeleeWeapon		(slf);	// VORSICHT: in v0.96c werden hier nicht die Fдuste, sondern die letzte Waffe gezogen !!! -> wird in v0.97 behoben sein (Kommentar dann lцschen)
		return;		
	}
	else
	{
		...
		// ---- ...herumliegende Waffe suchen, sonst mit den Fдusten kдmpfen ---- 								
		if (!B_FetchWeapon())
		{
