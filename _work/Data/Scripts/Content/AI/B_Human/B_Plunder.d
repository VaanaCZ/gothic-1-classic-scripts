...
//	B_TransferItems
//	===============
//	Ьbertrдgt das 'item' von 'other' zu 'self'. In 'amount' muЯ die
//	Anzahl der zu ьbertragenden Items ьbergeben werden.
//////////////////////////////////////////////////////////////////////////
...
//	B_CheckItem
//	===========
//	Ьberprьft den Inventoryslot 'slot' in der 'category' und ruft
//	bei Bedarf B_TransferItem() auf.
//	-> benцtigt 'self' und 'other'
...
func int B_CheckItem (var int category, var int slot)
{
	...
	var int count;  
	count = Npc_GetInvItemBySlot(other, category,slot);  			// initialisiert 'item' und gibt Anzahl zurьck
	...
	if (count > 0)
	{
		...
		// NEU: Nimmt nur Erz und davon nur die Hдlfte!
...
//	B_Plunder
//	=========
//	Durchsucht alle Inventoryslots, ьberprьft, welche Gegenstдnde er
...
//	neu:
//	----
//	- Dem Opfer wird die Hдlfte des vorhandenen Erzes abgenommen.
//
//	-> Gibt Anzahl der geplьnderten Gegenstдnde zurьck.
//////////////////////////////////////////////////////////////////////////
func int B_Plunder	()
{
	...
	// Zurьckgenommene Waffen werden nicht mitangegeben bei amountPlundered, da sich die SVMs dabei nur auf Erz beziehen.
	...
	//-------- Anzahl geplьnderter Items ausgeben ---------
