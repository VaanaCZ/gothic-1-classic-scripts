...
//	B_DrawWeapon
//	============
//	Dieser Befehl wдhlt die derzeit am besten geeignete Waffe aus und
//	zieht sie.
//////////////////////////////////////////////////////////////////////////
...
func void B_RemoveWeapon(var C_NPC slf)
{
	...
	//SN 26.01.01: wieder auskommentiert, da es das Problem vom 11.01.01 sowieso nicht behoben hat, und dazu noch vorausgegangene AI-Befehle (z.B. AI_FinishingMove) abwьrgt
	//B_FullStop			(slf);				// laut Ulf vom 11.01.01.: zur Sicherheit einbauen, da NSC-Caster oft in EV_UNREADY hдngen blieb
