...
const int BS_WALK					=	1	|	BS_FLAG_INTERRUPTABLE;								// PointAt nicht mцglich
const int BS_SNEAK					=	2	|	BS_FLAG_INTERRUPTABLE;
const int BS_RUN					=	3;									// PointAt nicht mцglich
const int BS_SPRINT					=	4;									// PointAt nicht mцglich
const int BS_SWIM					=	5;
const int BS_CRAWL					=	6;
const int BS_DIVE					=	7;
const int BS_JUMP					=	8;
const int BS_CLIMB					=	9 	|	BS_FLAG_INTERRUPTABLE;		// GEДNDERT!
