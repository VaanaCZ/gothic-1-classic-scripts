...
**		=============													**
**																		**
**		Enthдlt kleinere, universell verwendbare Befehle fьr die		**
**		Master-AI														**
**																		**
*************************************************************************/
...
//	B_GotoWPNextToNpc
//	=================
//	Ьberfrьft, ob der SC/NSC eine Waffe bzw. einen aggresiven Zauber 
//	in der Hand hдlt.
//////////////////////////////////////////////////////////////////////////
...
//19.09.00 (SN): VORSICHT, ich habe die Abfrage auf AI-Variable herausgenommen, da das a) Probleme bereitete, und b) nach einem Bugfix auch nicht mehr nцtig ist! -> getestet und funktioniert!!!
...
//		slf.aivar[AIV_ISLOOKING] = 1;								// ...und merken, daЯ es glotzt	
		return 1;
//	};
//	return 0;
};
...
{	
//	if ( slf.aivar[ AIV_ISLOOKING ] )								// schaut das Monster ьberhaupt?
//	{																// ...ja!		
		AI_StopLookAt( slf );
		PrintDebugNpc(PD_ZS_DETAIL,"C_StopLookAt");										// ...dann aufhцren lassen...
//		slf.aivar[ AIV_ISLOOKING ] = 0;								// ...und merken, daЯ es aufgehцrt hat!	
		return 1;		
//	};
//	return 0;
};
...
//	B_Say
//	=====
//	LдЯt den Nsc 'slf' einen SVM-Satz 'text' zum Nsc 'oth' sagen. Der
//	Sprecher sieht den Gesprдchspartner dabei an, bzw. dreht sich, falls
//	er den Hals zu sehr verrenken mьsste. 
//////////////////////////////////////////////////////////////////////////
...
//	der Ausfьhrung der folgenden AI-Befehle NICHT wartet, bis der Satz
...
func void B_SayOverlay(var C_NPC slf, var C_Npc oth, var string text)
{
	...
	//SN: VORSICHT: Bug #3046, wьrgt das SVM-Sample beim Zustandswechsel ab. Soll in v1.01 behoben sein.
...
//	B_StandUp
//	=========
//	Beendet alle mцglichen Sitzstellungen.
//////////////////////////////////////////////////////////////////////////
...
//	B_CallComrades
//	==============
//	Ruft die in der Nдhe befindlichen Kameraden heran.
//////////////////////////////////////////////////////////////////////////
...
//	B_CallGuards
//	============
//	Ruft die in der Nдhe befindlichen Wachen heran.
//////////////////////////////////////////////////////////////////////////
...
//	B_IntruderAlert
//	===============
//	Warnt vor Eindringling und ruft die in der Nдhe befindlichen
//	Kameraden heran.
//////////////////////////////////////////////////////////////////////////
...
//	B_FullStop
//	==========
//	Unterbricht jegliche Animation des NSCs. Hier wurde frьher AI_Standup()
//	verwendet. Dieser Befehl ist in einigen Situationen jedoch zu trдge
...
//	B_ResetTempAttitude
//	===================
//	Setzt den Wert der Temporдren Attitьde auf den der Permanenten!
//	Symbolisiert die Beruhigung des NSCs.
//	
//	Voraussetzungen:
//	- 'slf' muЯ ein NSC sein
//////////////////////////////////////////////////////////////////////////
...
//	Wenn er das Ziel sehen kann, wird nur ein einfacher AI_TurnTo ausgefьhrt.
//////////////////////////////////////////////////////////////////////////
...
//	=====================
//	Guckt sich um und sammelt die Waffe, die am nдchsten liegt wieder auf.
//	VORSICHT: Lцscht die globale Variable 'item' !
//////////////////////////////////////////////////////////////////////////
...
//	=====================
//	Guckt sich um und sammelt die Rьstung, die am nдchsten liegt wieder auf.
//	VORSICHT: Lцscht die globale Variable 'item' !
//////////////////////////////////////////////////////////////////////////
...
//	B_GotoFP
//	========
//	Geht zum nдchsten freien Freepoint. Checkt, ob der NSC nicht schon
//	dort steht!
//////////////////////////////////////////////////////////////////////////
...
//	B_SetAttackReason
//	=================
//	Setzt den Grund des Angriffs eines NSCs, damit spдter darauf 
...
func void B_KillNpc(var int npcInstance)
{
	...
	CreateInvItem		(npc,ItMi_Stuff_OldCoin_02);		// Mission-Item, das verhindert, daЯ die Toten entfernt werden
...
//	B_ChangeGuild
//	=============
//	Дndert die Gilde des angegebenen NSCs
//////////////////////////////////////////////////////////////////////////
...
//	B_ExchangeRoutine
//	=================
//	Дndert den Tagesablauf des angegebenen NSCs
//
//	VORSICHT:	Auf KEINEN Fall fьr 'self' innerhalb eines Dialoges
...
//	B_SetPermAttitude
//	=================
//	Дndert die permamente Attitьde des angegebenen NSCs zum SC
//////////////////////////////////////////////////////////////////////////
...
//	B_ClearImmortal
//	===============
//	Lцscht sas Immortal-Flag eines NPCs
//////////////////////////////////////////////////////////////////////////
...
//	B_GiveInvItems
//	==============
//	Ьbergibt ein Item von 'giver' an 'taker' und gibt eine Meldung
...
//	- der SC in keinem unpдЯlichen Bodystate ist
...
func int B_CheckForImportantInfo (var C_NPC slf, var C_NPC oth)
{
	...
	&&		C_NpcIsHuman(oth)	)	//SC kцnnte verwandelt sein 
	{
...
//	====================
//	Setzt bzw. resettet die Attitьde unter den Menschengilden
//	und berьcksichtigt dabei den Storyverlauf
//////////////////////////////////////////////////////////////////////////
