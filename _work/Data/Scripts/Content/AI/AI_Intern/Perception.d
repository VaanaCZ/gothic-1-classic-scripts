...
// *************************************
// SN: Demnдchst wird diese Tabelle mit der HAI_...-Tabelle aus AI_CONSTANTS.D zusammengefaЯt!
...
FUNC VOID InitPerceptions()
{
	...
	Perc_SetRange		(PERC_ASSESSQUIETSOUND	, PERC_DIST_INTERMEDIAT 		);	//MH: geдndert, 500 macht NSCs/Monster zu schwach
...
//	GuardPerception
//	===================
//	NSCs mit diesem Set haben erhцhte Aufmerksamkeit da sie aktive
//	Wahrnehmungen aktiviert haben. Sie mьssen als "Warner" fьr die
//	passiv wahrnehmenden 'OccupiedPerception'-NSCs fungieren. Da es Wachen sind
//	werden sie fьr den Watchfight nicht Ihre Posten verlassen
//////////////////////////////////////////////////////////////////////////
...
func void ObservingPerception ()
{
	...
	Npc_PercEnable  	(self,	PERC_DRAWWEAPON			, 	B_AssessFighter				);		
	Npc_PercEnable  	(self, 	PERC_ASSESSFIGHTSOUND	,	B_AssessFightSound			);
	Npc_PercEnable  	(self, 	PERC_ASSESSQUIETSOUND	,	B_AssessQuietSound			); // erst mal raus, weil beklauen sonst unmцglich wird
	Npc_PercEnable  	(self, 	PERC_CATCHTHIEF			,	ZS_CatchThief 				);
	Npc_PercEnable  	(self, 	PERC_ASSESSTHEFT		,	B_AssessTheft 				);
	Npc_PercEnable  	(self, 	PERC_ASSESSSURPRISE		,	ZS_AssessSurprise			);
	Npc_PercEnable  	(self, 	PERC_OBSERVESUSPECT		,	B_ObserveSuspect			);
...
//	OccupiedPerception
//	==================
//	Dieses Set beschrдnkt sich auf passive Wahrnehmungen. Gedacht fьr
//	normale Charaktere, die mit etwas beschдftigt sind.
//	WICHTIG: occupied-NSCs verlassen sich darauf, daЯ sie von anderen
...
//	DeepSleepPerception
//	===================
//	Minimalste Wahrnehmungen wдhrend eines tiefen Schlafes. Diese Jungs
//	wachen wirklich nur Schaden am eigenen Kцrper auf.
//////////////////////////////////////////////////////////////////////////
...
//	====================
//	Unruhiger Schlaf, der von der geringsten Stцrung unterbrochen wird.
//////////////////////////////////////////////////////////////////////////
