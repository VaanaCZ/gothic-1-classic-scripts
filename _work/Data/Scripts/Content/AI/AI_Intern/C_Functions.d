...
**		=============													**
**																		**
**		Enthдlt eine Reihe von Checks fьr die Master-AI					**
**																		**
*************************************************************************/
...
//	C_AmIStronger
//	=============
//	Ьberfrьft, ob der NSC 'slf' stдrker als der NSC 'oth' ist. Diese
...
//	C_AmIWeaker
//	===========
//	Ьberfrьft, ob der NSC 'slf' schwдcher als der NSC 'oth' ist. Diese
...
//	in der Hand hдlt. (Durchgangswachen interpretieren auch die sonst
...
//	=========================
//	Ьberfrьft, ob der SC/NSC einen neutralen oder benevolenten Zauber 
//	in der Hand hдlt.
//////////////////////////////////////////////////////////////////////////
...
func int C_NpcIsMonsterMage(var C_NPC slf)
{
	...
	&&	((slf.guild==GIL_DEMON		) 	||			// Skelett-Mage (hat aus SPECIES.D-technischen Grьnden Dдmonen-Gilde!)
...
func int  	C_BodyStateContains	(var C_NPC slf, var int bodystate)
{
	...
	if ((Npc_GetBodyState(slf)&(BS_MAX|BS_FLAG_INTERRUPTABLE|BS_FLAG_FREEHANDS)) == (bodystate&(BS_MAX|BS_FLAG_INTERRUPTABLE|BS_FLAG_FREEHANDS)))			// sowohl bei der Abfrage als auch beim Vergleichswert die hцhren Bits ausmaskieren!
	{																// ...ja!
		PrintDebugNpc( PD_ZS_DETAIL, "...true" );
		return TRUE;
	}
...
//	NSC einen NPCTYPE_FRIEND hat und es wird FALSE zurьckgegeben.
//////////////////////////////////////////////////////////////////////////
...
//	kдmpfen und dabei den eigenen Posten nicht verlassen soll
//////////////////////////////////////////////////////////////////////////
...
//	C_NpcIsBoss
//	===========
//	Ermittelt, ob der NSC zu einer der BOSS-Gilden gehцrt:
//	- Erzbarone
//	- Feuermagier
//	- Wassermagier
//	- Gurus
...
//	C_NpcIsWorker
//	=============
//	Ermittelt, ob der NSC zu einer der Arbeiter-Gilden gehцrt:
//	- Altes Lager: Buddler, Schatten
//	- Neues Lager: Schьrfer, Bauern, Banditen
...
//	C_NpcIsMage
//	===========
//	Ermittelt, ob der NSC ьber Magie verfьgt
//////////////////////////////////////////////////////////////////////////
...
//	=====================
//	Ermittelt, ob der NSC einer Gilde des Alten Lagers angehцrt!
//////////////////////////////////////////////////////////////////////////
...
//	=====================
//	Ermittelt, ob der NSC einer Gilde des Neuen Lagers angehцrt!
//////////////////////////////////////////////////////////////////////////
...
//	=====================
//	Ermittelt, ob der NSC einer Gilde des Sektenlagers angehцrt!
//////////////////////////////////////////////////////////////////////////
...
//	C_ChargeWasAttacked
//	===================
//	Ermittelt, ob ein Schьtzling der NSC-Wache attackiert wurde.
//////////////////////////////////////////////////////////////////////////
...
//	C_NpcHasSpell
//	=============
//	Ьberfrьft, ob der angegebene NSC den Zauberspruch 'spell'
//	im Inventory hat. 
//////////////////////////////////////////////////////////////////////////
...
//	C_NpcHasAmmo
//	============
//	Ьberfrьft, ob der angegebene NSC Munition der angegebenen Kategorie
//	im Inventory hat. 
...
//	C_NpcHasWeapon
//	==============
//	Ьberfrьft, ob der angegebene NSC eine Waffe der angegebenen Kategorie
//	im Inventory hat. Wird nach einer Fernkampfwaffe gefragt, so wird
//	nur "ja" zurьckgegeben, wenn auch passende Munition vorhanden ist
...
//	C_GetAttackReason
//	=================
//	Erfragt den Grund des Angriffs eines NSCs, damit spдter darauf 
...
//	=======================
//	Stellt fest, ob der feindliche NSC aus irgendwelchen Grьnden
