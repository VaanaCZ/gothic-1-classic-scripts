...
func VOID StoryHelper_INFO2_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO2, "ZURЬCK"			                			, StoryHelper_BACK2);
	Info_AddChoice		( StoryHelper_INFO2, "II:  Vorbereitung fьr die Beschwцrung"		, StoryHelper_PrepareRitual );
...
func void StoryHelper_INFO3_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO3, "III: Bereit fьr den Ork-Friedhof"	, StoryHelper_OrcGraveyard);
};
...
func void StoryHelper_INFO4_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO4, "ZURЬCK"										, StoryHelper_BACK4 );
	Info_AddChoice		( StoryHelper_INFO4, "IV:  Suche Teile fьr Ulu-Mulu"				, StoryHelper_SearchForUluMulu);
	Info_AddChoice		( StoryHelper_INFO4, "IV:  Bereit fьr Angriff auf die Freie Mine"	, StoryHelper_AttackFreeMine);
	...
	Info_AddChoice		( StoryHelper_INFO4, "IV:  Diego   - Freie Mine wurde ьberfallen"	, StoryHelper_FreeMineAmbush);
...
func void StoryHelper_INFO5_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO5, "ZURЬCK"									, StoryHelper_BACK5 );
	Info_AddChoice		( StoryHelper_INFO5, "V:  URIZIEL ist aufgeladen"				, StoryHelper_UrizielLoaded);
	Info_AddChoice		( StoryHelper_INFO5, "V:  Bereit fьr das Laden von URIZIEL"		, StoryHelper_LoadUriziel);
	...
	Info_AddChoice		( StoryHelper_INFO5, "V:  Bereit fьr die Ork-Stadt"				, StoryHelper_ReadyForOrcCity);
};
