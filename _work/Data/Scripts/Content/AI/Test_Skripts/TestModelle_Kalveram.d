...
{	
	...
	{   
		...
		Doc_PrintLine	( nDocID,  0, "aáŕâAÁŔÂ");
		...
		Doc_PrintLine	( nDocID,  1, "ÝŢßŕáâ");
		Doc_PrintLine	( nDocID,  1, "ăäĺćçč");
		Doc_PrintLine	( nDocID,  1, "éęëěíî");
		Doc_PrintLine	( nDocID,  1, "ďđńňóô");
		Doc_PrintLine	( nDocID,  1, "őö÷řůú");
		Doc_PrintLine	( nDocID,  1, "űüýţ˙");
