...
{ 
	PrintScreen( "B_SetCutScenePerceptions ...", -1, 50, "FONT_OLD_10_WHITE.TGA", 10 );
};
*/
...
{                 
	PrintScreen( "Applying druken overlay for 5000 ticks ...", -1, -1, "FONT_OLD_10_WHITE.TGA", 3 );
...
{                       
	PrintScreen( "Readying weapon ...", -1, 30, "FONT_OLD_10_WHITE.TGA", 3 );

	AI_StandUp				( self );
	AI_EquipBestMeleeWeapon	( self );     
	AI_ReadyMeleeWeapon 	( self );    
	
	PrintScreen( "Defending self ...", -1, 40, "FONT_OLD_10_WHITE.TGA", 3 );
	AI_Defend			( self );
};	
...
FUNC VOID Info_Test_Procedure_Choice()
{
	...
	Info_AddChoice		( Info_Test_Choice, "Äà."		, Info_Test_Procedure_Choice_Yes 	);
	Info_AddChoice		( Info_Test_Choice, "Íåò."		, Info_Test_Procedure_Choice_No 	);
...
FUNC VOID Info_Test_Procedure_Permanent_Important_Choice()
{
	...
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Äà."			, Info_Test_Procedure_Permanent_Important_Choice_Yes 		);
	Info_AddChoice		( Info_Test_Permanent_Important_Choice, "Íåò."			, Info_Test_Procedure_Permanent_Important_Choice_No 		);
