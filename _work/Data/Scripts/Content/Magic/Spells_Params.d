...
// ************************************************************************************************
// zum Casten benцtigtes, bzw. bei aufladbaren Spells maximal investierbares Mana
// ************************************************************************************************
...
// ************************************************************************************************
// Schaden der direkten Kampfsprьche
// ************************************************************************************************
...
// ************************************************************************************************
// HPs, die den Opfern in den Opferzustдnden abgezogen werden:
// ************************************************************************************************
...
// Achtung: wenn bei FREEZE (9) und SHORTZAPPED (2) die Werte geдndert werden, muЯ auch die Lebensdauer der PFX angepasst werden
...
// Ranges fьr NSC-Magie-Auswahllogik
...
// Dieser Wert ist auch die Obergrenze fьr die Reichweite der Spells und sollte sinnvollerweise so hoch sein, wie der Wert fьr Fernkampf

// FIXME: 	Bei allen Spells, bei denen der Schaden im Opfer-Zustand angegeben ist, kann KEIN Schadenstyp angwegeben werden!
//			Der Abzug von HPs erfolgt dann ьber den ChangeAttribute-Befehl! 
...
INSTANCE Spell_Firebolt (C_Spell_Proto)		// heiЯt jetzt "Magic Missile"
{
	time_per_mana			= 500;
...
{
	time_per_mana			= 250;
	damage_per_level		= SPL_DAMAGE_FIRERAIN; // 2 Level nцtig fьr PFX = 200 Feuerschaden!
	spelltype 				= SPELL_BAD;
	damageType				= DAM_FIRE;
	targetCollectAlgo		= TARGET_COLLECT_ALL_FALLBACK_NONE;	// Opfer werden aber erst durch Kollision mit dem Effekt "angezьndet"
...
INSTANCE Spell_MassDeath(C_Spell_Proto)
{
	...
	spelltype 				= SPELL_BAD;
	damageType				= DAM_MAGIC;
	targetCollectAlgo		= TARGET_COLLECT_ALL_FALLBACK_NONE;	// Opfer werden aber erst durch Kollision mit dem Effekt getцtet
	targetCollectRange		= 1000;					// 10m
	targetCollectAzi		= 360;
	targetCollectElev		= 60;
};
