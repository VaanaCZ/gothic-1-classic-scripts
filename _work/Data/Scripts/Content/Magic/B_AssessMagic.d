...
// FIXME: 	hier mьssen fьr jeden Spruch noch Fallunterscheidungen fьr MAIN / IMMORTAL Characters
//			berьcksichtigt werden, die evtl. nicht von den Sprьchen beeinfluЯt werden sollen!
...
func void B_AssessMagic_Firebolt()
{
	...
	//	Damit andere NSCs den Angriff wahrnehmen kцnnen
...
func void B_AssessMagic_Fear()
{
	...
	// Immunitдt fьr SLEEPER, TROLL, SWAMPSHARK, DEMON, SKELETONS, ZOMBIES, GOLEM
	if (	(self.guild	== GIL_SLF) 		||
			(self.guild == GIL_TROLL)		||
			(self.guild == GIL_SWAMPSHARK) 	||
			(self.guild == GIL_DEMON)		||
...
// Folgende Sprьche brauchen keinen B_AssessMagic weil sie nicht auf einen NSC wirken:
