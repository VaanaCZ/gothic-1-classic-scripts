func VOID STARTUP_SUB_PSICAMP ()
{
	...
	//-----------TEMPEL-Novizen-------------(auch fьr GroЯe Beschwцrung)------------------
	...
	//-------------CAMP-Novizen--------------------------------------------
	Wld_InsertNpc				(Nov_1300_Talas,"PSI_START");	//hдngt auf Tempelplatz rum (goobo-cave-heini)
	...
	Wld_InsertNpc				(Nov_1305_Joru,"PSI_START");	//Lehrer-Anwдrter. Lehrplatz 1
	...
	Wld_InsertNpc				(Nov_1313_Novize,"PSI_START");	//Schьler, Joru-Platz, Hut 12
	Wld_InsertNpc				(Nov_1314_Novize,"PSI_START"); 	//Hut 13
	Wld_InsertNpc				(Nov_1315_Novize,"PSI_START"); 	//Schьler, Joru-Platz, Hut 12
	...
	Wld_InsertNpc				(Nov_1326_Novize,"PSI_START");	//Schьler Baal Tondral (Platz 2)
	Wld_InsertNpc				(Nov_1327_Novize,"PSI_START"); //Hut 31, Fortuno-Platz
	Wld_InsertNpc				(Nov_1336_Novize,"PSI_START"); //Schьler 2, Baal Cadar
	Wld_InsertNpc				(Nov_1340_Novize,"PSI_START"); //Schьler 2, Baal Cadar
	Wld_InsertNpc				(Nov_1342_Novize,"PSI_START"); //Schьler Baal Tondral (Platz 2)
	Wld_InsertNpc				(Nov_1345_Novize,"PSI_START"); //Schьler 2, Baal Cadar
	Wld_InsertNpc				(Nov_1350_Novize,"PSI_START"); //KALOM PRIVATHAUS-WACHE
	Wld_InsertNpc				(Nov_1351_Novize,"PSI_START"); //Schmiede 24h
	Wld_InsertNpc				(Nov_1353_Novize,"PSI_START"); //Schьler Baal Tondral (Platz 2)
	...
	Wld_InsertNpc				(Tpl_1405_GorNaRan,"PSI_START");	//Stegwache 3, wahnsinner Sumpfhai-Jдger, 
	...
	Wld_InsertNpc				(Tpl_1439_GorNaDrak,"PSI_START");	//MC-Jдger, Fortuno-Platz
	Wld_InsertNpc				(Tpl_1440_Templer,"PSI_START");		//MC-Jдger, Fortuno-Platz
	...
	//-------------Lagerfremde-----------------------------------
	Wld_InsertNpc				(VLK_582_Melvin,"PSI_START");		//Joru-Schьler, Hut 12
};
...
func VOID INIT_SUB_PSICAMP ()
{
	...
	**************************************************************/
	...
	//Wld_AssignRoomToGuild("PSIH23",GIL_NOV); //Harloks Hьtte, Hut 31
	Wld_AssignRoomToGuild("PSIH24",GIL_NOV);
	//Wld_AssignRoomToGuild("PSIH25",GIL_NOV); Alchemielabor soll frei zugдnglich sein!
...
func VOID STARTUP_SUB_NEWCAMP ()
{
	...
	Wld_InsertNpc				(ORG_844_Lefty,"NC_DAM");	  	//Ricelords Schlдger, CF
	Wld_InsertNpc				(ORG_845_Schlaeger,"NC_DAM"); 	//Ricelords Schlдger, CF
	Wld_InsertNpc				(ORG_846_Schlaeger,"NC_DAM"); 	//Ricelords Schlдger, CF
...
func VOID INIT_SUB_NEWCAMP ()
{
	...
	**************************************************************/
	Wld_AssignRoomToGuild("NLHU25",GIL_ORG);	// Waypoint NC_HUT01 (SC-Hьtte)
	//Wld_AssignRoomToGuild("NLOBERM",GIL_BAU);	// Lee's Hцhle
	...
	//Wld_AssignRoomToGuild("NLHU14",GIL_BAU);	// Waypoint NC_HUT22 (Lares' Hьtte)
	...
	//Wld_AssignRoomToGuild("MAGE02",GIL_KDW);	//Alchemielabor frei zugдnglich!
	Wld_AssignRoomToGuild("MAGE03",GIL_KDW);	//NC_KDW05_IN
	//Wld_AssignRoomToGuild("MAGE04",GIL_KDW);	//Bibliothek frei zugдnglich!
	Wld_AssignRoomToGuild("MAGE05",GIL_KDW);	//NC_KDW03_IN
	Wld_AssignRoomToGuild("MAGE06",GIL_KDW);	//NC_KDW02_IN
	//Wld_AssignRoomToGuild("MAGHO4",GIL_KDW);	//Pentagrammhцhle frei zugдnglich
		
};

FUNC VOID STARTUP_SUB_OLDCAMP ()
{
	Wld_InsertNpc				(VLK_501_Buddler,"OC1"); //Hut 79, oben neben Sьdtor
	...
	Wld_InsertNpc				(VLK_512_Buddler,"OC1"); //Hut 64, Durchgangshьtte Bloodwyn/Markt 
	...
	Wld_InsertNpc				(VLK_519_Buddler,"OC1"); //Hut 43, Sьdturm-Tor
	...
	Wld_InsertNpc				(VLK_531_Buddler,"OC1"); //Hut 42, Neben SьdTurm-Ausgang
	...
	Wld_InsertNpc				(VLK_553_Buddler,"OC1"); //Hut 51, Neben SьdTurm-Ausgang
	Wld_InsertNpc				(VLK_554_Buddler,"OC1"); //Kyle UNTEN, Hut 72
	Wld_InsertNpc				(VLK_555_Buddler,"OC1"); //Hut 29, Huno Platz
	Wld_InsertNpc				(VLK_556_Buddler,"OC1"); //Hut 78, oben neben Sьdtor
	...
	Wld_InsertNpc				(VLK_578_Buddler,"OC1"); //Kyle-Platz, Hut 68 (2 Tьren)
	...
	Wld_InsertNpc				(Grd_211_Skip,"OC1");    //Hдndler, Scheune, OCC_MERCS_UPPER_LEFT_ROOM_BED4
	...
	Wld_InsertNpc				(Grd_216_Torwache,"OC1");//Sьdtor			
	Wld_InsertNpc				(Grd_217_Torwache,"OC1");//Sьdtor 			
	Wld_InsertNpc				(Grd_218_Gardist,"OC1"); //EBR-Haustьr, 24h
	...
	Wld_InsertNpc				(Grd_228_Gardist,"OC1"); //Sьdtor DrehKreuz  
	...
	Wld_InsertNpc				(Grd_245_Gardist,"OC1"); //EBR-Haustьr, 24h
	...
	Wld_InsertNpc				(Stt_311_Fisk,"OC1");	  //Hut 49 und 50, Marktplatz Hдndler
	...
	Wld_InsertNpc				(STT_330_Schatten,"OC1"); //Hut 44, Sьdturm-Tor
	...
	Wld_InsertNpc				(Grd_265_Gardist,"OC1");//OC Sьdtor (Ex-Fox)
...
FUNC VOID INIT_SUB_OLDCAMP ()
{
	...
	**   CS: Bei den Buddlerhьtten Kleinbuchstaben lassen,       **
	**                  sonst gehts nicht                        **
	**************************************************************/
	...
	// Wld_AssignRoomToGuild("hьtte1",GIL_VLK); //Diegos Hьtte
	...
	//Wld_AssignRoomToGuild("hьtte17",GIL_VLK); Durchgangshьtte, wird nicht auf jedes Betreten ьberwacht
	...
	//Wld_AssignRoomToGuild("hьtte26",GIL_VLK); //PLAYER Hьtte
	...
	//Wld_AssignRoomToGuild("hьtte64",GIL_VLK); Durchgangshьtte, wird nicht auf jedes Betreten ьberwacht
	Wld_AssignRoomToGuild("hьtte65",GIL_VLK);
	Wld_AssignRoomToGuild("hьtte66",GIL_VLK);
	Wld_AssignRoomToGuild("hьtte67",GIL_VLK);
	//Wld_AssignRoomToGuild("hьtte68",GIL_VLK); Durchgangshьtte, wird nicht auf jedes Betreten ьberwacht
...
//	Wld_AssignRoomToGuild("hьtte76",GIL_VLK);	Grahams Hьtte, abgesprochen mit Mike
...
FUNC VOID STARTUP_SUB_FREEMINECAMP ()
{
	...
	Wld_InsertNpc				( SLD_759_Soeldner, "FMC_ENTRANCE" );//FMC-Guard(Tьr zum Drehradhaus)		
	
	Wld_InsertNpc				( SLD_760_Soeldner, "FMC_ENTRANCE" );//FMC-Guard(Tьr zum Drehradhaus)		
	...
	Wld_InsertNpc				( SFB_1037_Swiney,	  "FMC_ENTRANCE" );//				OBER_SCHЬRFER
...
FUNC VOID STARTUP_SUB_SURFACE ()
{
	...
	Wld_InsertItem			(ItArScrollIcecube,"FP_SLEEP_OW_SNAPPER_HERD1_02"); // Snapperhцhle richtung Orkarena
	Wld_InsertItem			(ItFo_Potion_Health_02,"FP_SLEEP_OW_SNAPPER_HERD1_02");
	
	Wld_InsertItem			(ItFo_Potion_Mana_02,"FP_ROAM_OW_SNAPPER_WOOD05_02");// Snapper Hцhle im Wald
	
	Wld_InsertItem			(ItFo_POTION_HEALTH_02,"FP_SLEEP_OW_MOLERAT_CAVE4");// Nдhe bei Cavalorn
	
	Wld_InsertItem			(ItFo_POTION_HEALTH_01,"FP_ROAM_OW_MOLERAT_06_CAVE_GUARD2");//NДHE OC 
	
	Wld_InsertItem			(ItFo_POTION_HEALTH_01,"LOCATION_24_IN");//NДHE NC
	
	Wld_InsertItem			(ItFo_POTION_HEALTH_02,"LOCATION_23_CAVE_1_02");// DRUGMONOPOL
	
	Wld_InsertItem			(ItFo_POTION_HEALTH_03,"OW_PATH_07_15_CAVE3"); // BLOODHOUNDLOCATIOn NДHE NC
	...
	//Wld_InsertNpc       (Shadowbeast,"SPAWN_OW_SHADOWBEAST1_PSIWOOD_02");		//wird erst spдter in B_Story_LeftFM() gespawnt (Ulu-Mulu-Jagd)
	Wld_InsertNpc       (Shadowbeast,"SPAWN_OW_SHADOWBEAST2_PSIWOOD_02");
	//Wld_InsertNpc       (Shadowbeast,"OW_PATH_033_TO_CAVE5");					//wird erst spдter in B_Story_LeftFM() gespawnt (Ulu-Mulu-Jagd)
	...
	Wld_InsertNpc		(Snapper,"SPAWN_OW_WARAN_01_BADITS6"); // WEG ZUR TROLLSCHLUCHT,DA MЬSSEN STДRKERE MONSTER HIN
	...
	Wld_InsertNpc		(Snapper,"SPAWN_OW_SCA_01_BADITS7");// WEG ZUR TROLLSCHLUCHT,DA MЬSSEN STДRKERE MONSTER HIN
	...
	// Plateau ьber der verlassenen Mine
	...
	// zwischen Jдgern und Brьcke zum OC
	...
	//-------------Camp im Lager ьber Cavalorns Hьtte---------------------------
...
//	Wld_InsertNpc				(NON_1504_WEGELAGERER,"OW_PATH_BANDITOS01");
	...
	// in der Grabenhцhle unter dem Baumstamm
    ...
    //Wld_InsertNpc		(Troll,"OW_RUIN_TROLL");	//wird erst spдter in B_Story_LeftFM() gespawnt!
    

	//-----------------------STEINKREIS---------------------------------//
	// Hцhle auf Bergweg vor Milten
	...
	// Ork-Stadt: Schamanenhцhle
	Wld_InsertNpc	(OrcWarrior4,"OW_ORC_SHAMAN_PATH1");
	Wld_InsertNpc	(OrcWarrior4,"OW_ORC_SHAMAN_PATH1");
	
	// Ork-Stadt: Zugang zum Sдulenplatz
	...
	//2. Stollensystem hinter groЯer Hцhle
...
FUNC VOID STARTUP_ORCTEMPEL ()
{
	...
	//NOV
	Wld_InsertNpc				( NOV_1359_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	Wld_InsertNpc				( NOV_1360_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	Wld_InsertNpc				( NOV_1361_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	Wld_InsertNpc				( NOV_1362_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	Wld_InsertNpc				( NOV_1363_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	Wld_InsertNpc				( NOV_1364_Novize,	"TPL_408" ); // Betet zum Schlдfer in der Schlдferhalle
	...
	// ----------------- Sleeper ---------------------------------------
	Wld_InsertNpc				( SLEEPER, "TPL_395" ); // Schlдft die ganze Zeit :)
};
