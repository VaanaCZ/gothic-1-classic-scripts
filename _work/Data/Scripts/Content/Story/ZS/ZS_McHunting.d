...
// da nur AssessEnemy die Wahrnehmung fьllen wьrde
{
...
func void ZS_MCHunting_Loop ()
{
	...
	// sollte Minecrawlerjдger was rumlaufen noch ?
	if (Wld_DetectNpc (self,-1,NOFUNC,GIL_MINECRAWLER) ) // ist hier ein Minecrawler? 
	{
		...
		Npc_GetTarget	( self);
		AI_StartState (self,ZS_AssessMonster, 0,"");	// SN: der korrekte Zustand, um Monster zu erkennen ist 'ZS_AssessMonster' -> ich habe das korrigiert! (wenn gelesen, dann Kommentar lцschen)
	}
	else 
	{
