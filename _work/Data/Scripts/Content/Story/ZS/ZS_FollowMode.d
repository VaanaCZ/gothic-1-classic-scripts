...
//	darauf, daЯ der Spieler ihn anredet. Ьber Infos/Missions dieses
//	NSCs geht dann die Handlung weiter. Meistens geht es in den 
//	Zustand ZS_FollowMode.
//	
//	NSC reagiert auЯerdem auf:
//	- angegriffen werden	->	ein "entschдrfter" Kampf
//	- bezaubert werden		-> 	nцtig fьr das korrekte Funktionieren
//								des Magiesystems (-> Opfer-Zustдnde...)
...
//	B_FriendlyAttack
//	================
//	Sorgt dafьr, daЯ ohne Umschweife sofort in den ZS_FriendlyAttack
//	gesprungen wird.
//////////////////////////////////////////////////////////////////////////
...
//	ZS_FriendlyAttack
//	=================
//	Dies ist ein "entschдrfter" ZS_Attack, der davon ausgeht, daЯ der
//	NSC gerade wichtig fьr die Fortfьhrung der Spielhandlung ist und
//	grundsдtzlich an Kampf nicht interessiert ist.
//
//	Der Kampf folgt folgenden Regeln:
//	-	NSC wird den SC so schnell wie mцglich bewuЯtlos schlagen,
//		nie aber tцten
//	- 	Hat der NSC den SC bewuЯtlos geschlagen, wird er ihn NICHT
//		plьndern
//	-	Steckt der Spieler im Kampf die Waffe weg, wird auch der NSC
//		den Kampf beenden
//	- 	Lдuft der Spieler weg, wird der NSC keine Verfolgung aufnehmen,
...
func int ZS_FriendlyAttack_Loop()
{
	...
	//-------- AnschmeiЯen der FAI fьr diesen Frame --------
	//PrintGlobals		(PD_ZS_CHECK);
...
//
//	WICHTIG:	Der NSC der diesen FollowMode bekommt muЯ SENSE_SMELL
//				verpaЯt bekommen, da er sonst den zurьckbleibenden
//				Spieler in seinem Rьcken nicht erkennt
//
//	B_FollowMode
//	============
...
//	B_CheckDistToPlayer
//	===================
//	Ьberprьft innerhalb der ZS_Followmode regelmдЯig die Entfernung zum
//	Spieler und schaltet bei ьberschreiten der Maximaldistanz den Zustand.
...
func void B_CheckDistToPlayer ()
{
	...
	{
		// Hier ist der NPC angekommen - keine Reaktion erwьnscht
	}
...
//	vom zu begleitenden NSC entfernt (SC bleibt zurьck oder sprintet
//	voraus).
//
//	NSC reagiert auЯerdem auf:
//	- angegriffen werden	->	ein "entschдrfter" Kampf
