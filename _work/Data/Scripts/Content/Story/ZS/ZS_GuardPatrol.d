...
/* 	in die Funktionen soll noch ein Zдhlglied, daЯ aber von der Funktionsweise der 
	Begin-Loop-End-Struktur abhдngig, wo das Zдhlglied eingefьhrt und verwendet wird;
	mit diesem Glied wird nach einer Anzahl "rumlaufen" Vorgдngen der Nsc wieder zu seinem self.wp 
	geschickt, damit er nicht irgendwann am Ende des Levels ankommt */
{
	...
	else
	{
		...
		var int hlprand;					// Hilfsvariblendeklaration fьr einen Randomwert
		...
		/* Ist der nдchste ermittelte Wegpunkt von den schon angesteuerten Verschieden ?-->ja*/
		{
		...
		else 								// nicht verschieden
		{
			...
			AI_Wait (self,10);						// Warten fьr 10 Sekunden
