...
//	ZS_StandAround
//	==============
//	Der NSC sucht sich fьr diesen Tagesablauf-Zustand  einen FP 'STAND'
//	und fьhrt eine groЯe Anzahl an zufдlligen Ambient-Aktionen durch:
//	->	Essen
//	->	Trinken
//	->	Rauchen
//	->	Pinkeln gehen
...
//	ToDo:
//	-----
//	- Manche Ьbergдnge von T_..._RANDOM_X nach S_..._S0 poppen unschцn
////////////////////////////////////////////////////////////////////////////
func void ZS_StandAround ()
{
	...
	//-------- Wahrnehmungen --------
	// R$ьckkehr in ZS_SmallTalk wird enabled
...
func int ZS_StandAround_Loop ()
{
	...
	//-------- Feinpositionierung abhдngig von Vorgдngerzustand! --------
	if Npc_WasInState(self,ZS_Smalltalk)
	{
