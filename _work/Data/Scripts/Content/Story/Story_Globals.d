...
var int BaalLukor_BringParchment;
		// 0:	keine Hдlfte gefunden
		// 1:	die erste Hдlfte gefunden
		// 2:	die zweite Hдlfte gefunden
		// 3:	beide Hдlften gefunden
...
var int Troll_Wheel;
		//fьr Wheel in der Trollschlucht		
		// 0:	Auftrag nicht vergeben
...
const int HighPriest_MaxHit = 3;		//Anzahl der Schlдge auf den fьnften Ork-Priester, bis der "SC-hats-kapiert-Dialog" kommt
...
//	KAPITEL 3
//---------------------------------------------------------------------
const int	XP_SaveBaalLukor			=	750;		//22.01.01: Ork-Graveyard enthдlt 4620 XP
...
( da die Logeintrдge nicht einfach so in permanenten Infos stehen dьrfen!) 
