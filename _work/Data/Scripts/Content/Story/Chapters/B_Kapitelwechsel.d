...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel)
{
	...
	else if (neues_Kapitel == 4)
	{
		...
		B_LogEntry			(CH4_Firemages,"Saturas, capo dei Maghi dell'Acqua, mi ha chiesto un ultimo favore. Per far esplodere il cumulo di metallo, gli serve l'aiuto dei Maghi del Fuoco di Campo Vecchio. Non so come persuadere i maghi di Gomez a prender parte a un piano che distruggerà le fondamenta del loro potere, ma penserò a qualcosa.");
	...
	else if (neues_Kapitel == 5)
	{
		...
		//-------- Tagebucheinträge --------
		B_LogEntry		(CH4_EnterTemple,	"Gorn non era molto convinto che l'ULU-MULU mi avrebbe aiutato, nella città degli orchi. Cosa sarebbe accaduto, l'avrei scoperto molto presto... in un modo o nell'altro!");
