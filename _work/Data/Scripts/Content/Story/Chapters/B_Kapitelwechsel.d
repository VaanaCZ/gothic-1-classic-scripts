...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel)
{
	...
	else if (neues_Kapitel == 4)
	{
		...
		//IntroduceChapter ("Kapitel 4","Ксардас","chapter4.tga","levelup.wav", 6000); 
	...
	else if (neues_Kapitel == 5)
	{
		...
		//-------- Tagebucheintrдge --------
		B_LogEntry		(CH4_EnterTemple,	"Gorn war wenig zuversichtlich, daЯ mir das ULU-MULU in der Orkstadt viel helfen wьrde. Was solls, ich werde es sehr bald herausgefunden haben... so oder so!");

		//-------- Oberwelt-Monster nochmal "nachfьllen" --------	
		B_Story_RespawnOW();
		
		//IntroduceChapter ("Kapitel 5","Die Hьter des Portals","chapter5.tga","levelup.wav", 6000);
	...
	else if (neues_Kapitel == 6)
	{
		...
		//IntroduceChapter ("Kapitel 6","Die Hallen des Schlдfers","chapter6.tga","levelup.wav", 6000);
