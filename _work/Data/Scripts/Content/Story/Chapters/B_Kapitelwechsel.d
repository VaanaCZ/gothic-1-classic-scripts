...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel)
{
	...
	else if (neues_Kapitel == 4)
	{
		...
		B_LogEntry			(CH4_Firemages,"Saturas, el líder de los Magos del Agua, me ha pedido un último favor. Para volar el montículo de mineral necesita la ayuda de los Magos del Fuego del Campamento Viejo. No sé cómo convencer a los magos de Gómez de que tomen parte en un plan que destruirá los cimientos de sus poderes, pero ya pensaré en algo.");
	...
	else if (neues_Kapitel == 5)
	{
		...
		//-------- Tagebucheinträge --------
		B_LogEntry		(CH4_EnterTemple,	"Gorn no confiaba demasiado en que el ULU-MULU me fuera útil en la ciudad orca. No importa; de todos modos, pronto descubriré si estaba en lo cierto.");
