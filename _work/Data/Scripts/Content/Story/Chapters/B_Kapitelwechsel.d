...
FUNC VOID B_Kapitelwechsel (VAR INT neues_Kapitel)
{
	...
	if		(neues_Kapitel == 1)
	{
		...
		IntroduceChapter ("Rozdział 1","Witamy w Kolonii!","chapter1.tga","levelup.wav", 6000);
	}
	...
	else if	(neues_Kapitel == 2)
	{
		...
		IntroduceChapter ("Rozdział 2","Gniazdo pełzaczy","chapter2.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 3)
	{
		...
		IntroduceChapter ("Rozdział 3","Starożytna magia","chapter3.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 4)
	{
		...
		B_LogEntry			(CH4_Firemages,"Saturas, przywódca Magów Wody poprosił mnie o ostatnią przysługę. Aby wysadzić w powietrze kopiec rudy, magowie z Nowego Obozu potrzebują pomocy swych braci z Kręgu Ognia. Nie wiem jeszcze, w jaki sposób uda mi się przekonać magów Gomeza do współpracy, ale spróbuję wymyślić coś po drodze.");
		...
		IntroduceChapter ("Rozdział 4","Xardas","chapter4.tga","levelup.wav", 6000); 
	}
	...
	else if (neues_Kapitel == 5)
	{
		...
		//-------- Tagebucheinträge --------
		B_LogEntry		(CH4_EnterTemple,	"Gorn nie był przekonany co do skuteczności mojego amuletu ochronnego. Cóż... Wkrótce na własnej skórze przekonam się, kto ma rację!");

		//-------- Oberwelt-Monster nochmal "nachfüllen" --------	
		B_Story_RespawnOW();
		
		//IntroduceChapter ("Kapitel 5","Die Hüter des Portals","chapter5.tga","levelup.wav", 6000);
		IntroduceChapter ("Rozdział 5","Strażnicy portalu","chapter5.tga","levelup.wav", 6000);
	}
	...
	else if (neues_Kapitel == 6)
	{
		...
		IntroduceChapter ("Rozdział 6","Leże Śniącego","chapter6.tga","levelup.wav", 6000);
	};
};
