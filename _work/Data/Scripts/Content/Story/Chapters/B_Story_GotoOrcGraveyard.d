...
func void B_Story_GotoOrcGraveyard()
{
	...
	B_LogEntry			(CH3_OrcGraveyard,"The great invocation of the Sleeper didn't meet the expectations. There were only very vague images of Orcs in their caves to be seen. Y'Berion, the spiritual leader of the Brotherhood, became unconscious as a result of his endeavors during the invocation!"); 
	B_LogEntry			(CH3_OrcGraveyard,"Cor Angar, the leader of the templars, asked me to go to the Orc cemetery, a cave system near the swamp camp. Guru Baal Lukor has already gone there with some templars to look for further hints so they can understand the vision of the Orcs better.");
