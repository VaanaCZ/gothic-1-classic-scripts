...
func void B_Story_BringFoci()
{
	...
	B_LogEntry			(CH3_BringFoci,"After I passed on the focus and the almanac from the swamp camp to Saturas, he asked me to find the remaining four focus stones, which are not in the possession of the Magicians of Water yet.");
	B_LogEntry			(CH3_BringFoci,"Saturas gave me an old map with the last known locations of the focus stones, as well as a magic scroll which will teleport me back to the Magicians of Water.");
	B_LogEntry			(CH3_BringFoci,"Riordian, one of the Magicians of Water, has brewed me some potions for my travels. I can collect them in his alchemy lab on the upper level of the New Camp.");
