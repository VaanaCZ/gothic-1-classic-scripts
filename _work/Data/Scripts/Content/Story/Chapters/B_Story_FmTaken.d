...
func void B_Story_FMTaken()
{
	...
	{
		B_LogEntry	(CH4_Firemages,"Diego opowiedział mi nieco więcej o wydarzeniach w Starym Obozie.");
	}
	else
	{
		B_LogEntry	(CH4_Firemages,"Przy tylnym wejściu do Starego Obozu spotkałem Diego, który opowiedział mi o tragicznych wydarzeniach ostatnich dni.");
	};
	B_LogEntry		(CH4_Firemages,"Po zawaleniu się Starej Kopalni, Gomez rozkazał swoim ludziom zaatakować należącą do Nowego Obozu Wolną Kopalnię. Wobec zdecydowanego sprzeciwu Corristo i jego Magów Ognia, Gomez kazał ich wszystkich zamordować.");
	B_LogEntry		(CH4_Firemages,"Mam czym prędzej wrócić do Nowego Obozu i zdać Saturasowi relację z tych wydarzeń.");
	
	if (Scorpio_Exile == FALSE)
	{
		Log_CreateTopic (GE_TraderOW,LOG_NOTE);
		B_LogEntry		(GE_TraderOW,"Skorpion porzucił Stary Obóz i wraz z Cavalornem zatrzymał się w myśliwskiej chacie na drodze pomiędzy Starym a Nowym Obozem.");
		Scorpio_Exile = TRUE;
	};
