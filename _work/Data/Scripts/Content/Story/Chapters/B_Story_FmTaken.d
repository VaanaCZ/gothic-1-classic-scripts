...
func void B_Story_FMTaken()
{
	...
	{
		B_LogEntry	(CH4_Firemages,"Diego mi byl schopen øíci o událostech ve Starém táboøe nìco víc.");
	}
	else
	{
		B_LogEntry	(CH4_Firemages,"U zadního vchodu do Starého tábora mì Diego zastavil a varoval mì pøed øadou incidentù, které se tu nyní odehrávají.");
	};
	B_LogEntry		(CH4_Firemages,"Po zavalení Starého dolu pøikázal Gomez svým mužùm, aby napadli Svobodný dùl patøící Novému táboru. Když se Corristo a mágové Ohnì proti tomuto plánu zpìèovali, Gomezovi muži je zavraždili.");
	B_LogEntry		(CH4_Firemages,"Musím co nejrychleji Nový tábor varovat a informovat Saturase o tomto incidentu. Kéž to stihnu vèas.");
	
	if (Scorpio_Exile == FALSE)
	{
		Log_CreateTopic (GE_TraderOW,LOG_NOTE);
		B_LogEntry		(GE_TraderOW,"Scorpio zùstal ve Starém táboøe a teï obývá spolu s Cavalornem loveckou chýši mezi Starým a Novým táborem.");
		Scorpio_Exile = TRUE;
	};
