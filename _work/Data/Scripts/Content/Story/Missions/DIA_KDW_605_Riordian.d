...
{
	AI_Output (other, self,"Info_Riordian_NEWS_15_01"); //Saturas mì poslal.
	AI_Output (self, other,"Info_Riordian_NEWS_14_02"); //Á, tak pojï. Už mi øíkali.
	AI_Output (self, other,"Info_Riordian_NEWS_14_03"); //Tady si vezmi lektvar, ten vyléèí všechny neduhy.
	AI_Output (self, other,"Info_Riordian_NEWS_14_04"); //Teï jdi a pøines nám ohniskové kameny. Ty jsou naší jedinou nadìjí.
...
instance Info_Riordian_REWARD (C_INFO)
{
	...
	permanent	= 0;
	important 	= 0;
	description = "Saturas øekl, že mì máš odmìnit.";
};
...
{
	AI_Output			(other, self,"Info_Riordian_REWARD_15_01"); //Saturas øekl, že mì máš odmìnit.
	AI_Output			(self, other,"Info_Riordian_REWARD_14_02"); //Á, pojï dál, pojï dál.
	AI_Output			(self, other,"Info_Riordian_REWARD_14_03"); //Náš duchovní vùdce mi vyprávìl o tvých hrdinských èinech.
	AI_Output			(self, other,"Info_Riordian_REWARD_14_04"); //Všichni lidé v táboøe - ne, v celé kolonii - jsou ti hluboce zavázaní.
	AI_Output			(self, other,"Info_Riordian_REWARD_14_05"); //Pøijmi tuhle malou odmìnu za všechno tvoje úsilí.
	...
	B_LogEntry			(CH3_BringFoci,"Riordian byl  jako vždy hlava otevøená. Dal mi spoustu lektvarù. Myslím, že mi jich bude zapotøebí.");
...
{
	AI_Output (self, hero,"Info_Riordian_MESSAGE_14_01"); //Jsem rád, že jsi pøišel! Oèekával jsem tì!
};
...
instance Info_Riordian_MESSAGEWHY (C_INFO)
{
	...
	permanent	= 0;
	important 	= 0;
	description = "Oèekával jsi mì? Jak to?";
};
...
{
	AI_Output (hero, self,"Info_Riordian_MESSAGEWHY_15_01"); //Oèekával jsi mì? Jak to?
	AI_Output (self, hero,"Info_Riordian_MESSAGEWHY_14_02"); //Gorn mi øíkal, abych tì k nìmu poslal ihned, jak pøijdeš!
	AI_Output (hero, self,"Info_Riordian_MESSAGEWHY_15_03"); //Co se dìje?
	AI_Output (self, hero,"Info_Riordian_MESSAGEWHY_14_04"); //Má plán na osvobození obsazeného dolu.
	AI_Output (hero, self,"Info_Riordian_MESSAGEWHY_15_05"); //Støeží poøád vchod toho dolu?
	AI_Output (self, hero,"Info_Riordian_MESSAGEWHY_14_06"); //Ano! Zajdi za ním, prosím, co nejdøíve!
};
/*------------------------------------------------------------------------
//							WELCOME							//
------------------------------------------------------------------------*/
...
{
	AI_Output (self, other,"KDW_605_Riordian_HEAL_Info_14_01"); //Jestliže budeš zranìn, já tì vyhojím.
};
// ***************************** INFOS ****************************************//
...
{
	AI_Output (other, self,"KDW_605_Riordian_HEALINFO_Info_15_01"); //Jsem zranìn. Dokážeš mì vyhojit?
	AI_Output (self, other,"KDW_605_Riordian_HEALINFO_Info_14_02"); //Tìmito slovy vyvolávám léèivé síly a tvoje tìlo i duše budou uzdraveny!
...
instance  KDW_605_Riordian_GREET (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description		= "Buï pozdraven, mágu."; 
};
...
{
	AI_Output 		(other, self,"KDW_605_Riordian_GREET_Info_15_01"); //Buï pozdraven, mágu.
	AI_Output 		(self, other,"KDW_605_Riordian_GREET_Info_14_02"); //Jsem Riordian, alchymista. Ty urèitì chceš nìjaký lektvar?
	Log_CreateTopic (GE_TraderNC,LOG_NOTE);
	B_LogEntry 		(GE_TraderNC,"Riordian, mág Vody, obchoduje s LEKTVARY. Bývá v alchymistické dílnì v horní rovinì.");
