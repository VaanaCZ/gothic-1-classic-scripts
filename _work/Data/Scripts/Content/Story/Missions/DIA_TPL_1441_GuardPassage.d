...
func void Info_TPL_1441_FirstWarn_Info()
{
	...
	AI_Output 		(self, hero,"Info_TPL_1441_FirstWarn_13_01"); //FERMO! Puoi entrare nel tempio solo se hai il permesso di un guru!
	...
	if (Npc_KnowsInfo(hero, PC_Psionic_SEND))
	{
		...
		Info_Addchoice 		(Info_TPL_1441_FirstWarn,"Ho l'autorizzazione di Y'Berion in persona.",	Info_TPL_1441_FirstWarn_Condition_YBERION);  
		Info_Addchoice 		(Info_TPL_1441_FirstWarn,"Mi manda Lester il novizio.",	Info_TPL_1441_FirstWarn_Condition_LESTER);  
	}
	else
	{
...
{
	AI_Output (hero, self,"Info_TPL_1441_FirstWarn_Condition_YBERION_15_01"); //Ho l'autorizzazione di Y'Berion in persona.
	AI_Output (self, hero,"Info_TPL_1441_FirstWarn_Condition_YBERION_13_02"); //Da queste parti i bugiardi perdono facilmente la lingua. Attento a ciò che dici!
};

func void Info_TPL_1441_FirstWarn_Condition_LESTER ()
{
	AI_Output (hero, self,"Info_TPL_1441_FirstWarn_Condition_LESTER_15_01"); //Mi manda Lester il novizio, per offrire i miei servizi a Y'Berion.
	AI_Output (self, hero,"Info_TPL_1441_FirstWarn_Condition_LESTER_13_02"); //Lester è affidabile, lo conosco. Puoi passare.
	Info_Clearchoices 	(Info_TPL_1441_FirstWarn);
...
{
	AI_Output 		(self, hero,"Info_TPL_1441_LastWarn_13_01"); 		//Un altro passo e sei morto!
