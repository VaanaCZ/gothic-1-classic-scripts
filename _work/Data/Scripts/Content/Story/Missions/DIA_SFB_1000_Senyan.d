...
{	
	...
	AI_Output (self, other,"DIA_Senyan_Hello_01_01"); //Tak. Skąd wiesz?
	AI_StopProcessInfos	(self);
};
...
INSTANCE DIA_Senyan_JustTalk(C_INFO)
{
	...
	permanent	= 1;
	description = "Chcę z tobą chwilę porozmawiać?";
};                       
...
{	
	AI_Output (other, self,"DIA_Senyan_JustTalk_15_00"); //Chcę z tobą chwilę porozmawiać.
	AI_Output (self, other,"DIA_Senyan_JustTalk_01_01"); //Nie przyszedłem tutaj, żeby gadać.
	AI_StopProcessInfos	(self);
};
