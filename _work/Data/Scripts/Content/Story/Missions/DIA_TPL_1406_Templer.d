...
instance  DIA_KalomsGuard_PERM (C_INFO)
{
	...
	permanent	= 1;
	description	= "Chyba nie będziesz miał nic przeciwko, jeśli tam wejdę?";
};                       
...
{
	AI_Output (other, self,"DIA_KalomsGuard_PERM_15_00"); //Chyba nie będziesz miał nic przeciwko, jeśli tam wejdę?
	AI_Output (self, other,"DIA_KalomsGuard_PERM_13_01"); //Okazuj mojemu mistrzowi należyty szacunek, albo nie pożyjesz długo!
	AI_StopProcessInfos	( self );
};
