...
FUNC void  ORG_862_Jacko_GUARD_Info()
{
	...
	B_LogEntry			(CH1_DrugMonopol,"Znalazłem miejsce, w którym wytwarzano ziele. Zajmuje się tym Jacko i dwóch jego kompanów.");

	Info_Clearchoices	(ORG_862_Jacko_GUARD);
	Info_Addchoice		(ORG_862_Jacko_GUARD,"Cor Kalom wysłał pięciu Strażników Świątynnych, którzy mają was wykończyć.",ORG_862_Jacko_GUARD_Templer);
...
func void ORG_862_Jacko_GUARD_Templer()
{
	...
	B_LogEntry			(CH1_DrugMonopol,"Przy pomocy zmyślonych Strażników Świątynnych udało mi się rozpędzić tę bandę mięczaków. Na jakiś czas problem został zażegnany.");
...
func void ORG_862_Jacko_GUARD_InfoWert()
{
	...
	Stooges_Fled = TRUE;
	B_LogEntry			(CH1_DrugMonopol,"Sprytna gadka pozwoliła mi rozwiązać kolejny problem. Jacko uznał, że robi się za gorąco, więc postanowił dać nogę.");
	B_GiveXP			(XP_JackoRetired);
