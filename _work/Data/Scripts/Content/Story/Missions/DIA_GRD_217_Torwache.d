...
{
	AI_Output (other, self,"DIA_Grd_217_First_15_00"); //Cześć!
	AI_Output (self, other,"DIA_Grd_217_First_06_01"); //Rusz swoje cztery litery! Wchodź albo wychodź - mam to gdzieś. Tylko zejdź mi wreszcie z oczu!
	AI_StopProcessInfos	( self );
};
