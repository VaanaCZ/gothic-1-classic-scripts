...
{
	AI_Output (self, other,"Info_Erpresser_Info_13_01"); //Hej, chłopcze! Jeśli chcesz wejść do środka, będziesz musiał zapłacić 10 bryłek, kapujesz?
	
	Info_ClearChoices( Info_Erpresser );
	Info_AddChoice	 ( Info_Erpresser,"To dlaczego nie przyjdziesz tutaj i ich sobie nie weźmiesz!", Info_Erpresser_Choice_AufsMaul );
	Info_AddChoice	 ( Info_Erpresser,"Trzy bryłki? To niewiele. Proszę bardzo...", Info_Erpresser_Choice_Zahlen );
};

FUNC VOID Info_Erpresser_Choice_AufsMaul()
{
	AI_Output (other, self,"Info_Erpresser_Choice_AufsMaul_15_01"); //To dlaczego nie przyjdziesz tutaj i ich sobie nie weźmiesz!
	AI_Output (self, other,"Info_Erpresser_Choice_AufsMaul_13_02"); //Dzięki, stary. Właśnie zaczynałem się nudzić.
...
FUNC VOID Info_Erpresser_Choice_Zahlen()
{
	...
	{
		AI_Output (other, self,"Info_Erpresser_Choice_Zahlen_15_01"); //Proszę, oto 10 bryłek.
	...
	{
		AI_Output (other, self,"Info_Erpresser_Choice_Zahlen_15_03"); //Ummm... Nie mam przy sobie 10 bryłek.
...
{
	AI_Output (self, other,"Info_BereitsErpresst_Info_13_02"); //Zapłaciłeś - możesz przejść. Właź, zanim się rozmyślę.
};
...
{
	AI_Output (self, other,"Info_BereitsAufsMaul_Info_13_02"); //Spadaj zanim zetrę ten głupi uśmiech z twojej gęby!
};
