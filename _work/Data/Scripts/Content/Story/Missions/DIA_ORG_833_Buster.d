...
INSTANCE DIA_ORG_833_Buster3 (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Jak mi mùžeš pomoci?"; 
};
...
{
	AI_Output (self, other,"DIA_ORG_833_Buster3_02_01"); //Mùžu ti ukázat, jak ovládat své tìlo. To je umìní AKROBACIE.
...
FUNC void DIA_ORG_833_Buster_Train1()
{
	...
	{
		AI_Output (self, other,"DIA_ORG_833_Buster3_02_02"); //Brzy získáš kontrolu nad svým tìlem a budeš schopen skákat mnohem dál.
		AI_Output (self, other,"DIA_ORG_833_Buster3_02_03"); //Nauèil ses, jak se stoèit a jak nejlépe pøi pádu dopadnout na zem. Ale nezapomeò - nejsi nesmrtelný!
		AI_Output (self, other,"DIA_ORG_833_Buster3_02_04"); //Akrobacie mùže být také velmi užiteèná v boji. Mùžeš velmi rychle mìnit vzdálenost mezi tebou a tvým nepøítelem. Hodnì štìstí!
	};		
};  
