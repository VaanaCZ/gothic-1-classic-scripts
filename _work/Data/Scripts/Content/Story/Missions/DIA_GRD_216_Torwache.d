...
{
	AI_Output (self, other,"DIA_Grd_216_First_13_00"); //Hej, ty! Chyba cię tu wcześniej nie widziałem!
	AI_Output (other, self,"DIA_Grd_216_First_15_01"); //Nic dziwnego. Dopiero co tutaj trafiłem.
	AI_Output (self, other,"DIA_Grd_216_First_13_02"); //To lepiej uważaj! Poza murami jest bardzo niebezpiecznie. Tylko w obozie możesz spać spokojnie.
};
...
{
	AI_Output			(self, other,"DIA_Grd_216_Dusty_Zoll_13_00"); //Stój! Dokąd zabierasz naszego drogiego przyjaciela?
	...
	Info_AddChoice		(DIA_Grd_216_DustyZoll,"Udajemy się do obozu Bractwa.",DIA_Grd_216_DustyZoll_ToPSI);
	if (Npc_HasItems (other,itminugget) >= 100)
	{
		Info_AddChoice	(DIA_Grd_216_DustyZoll,"Idziemy się przespacerować. A oto 100 bryłek rudy.",DIA_Grd_216_DustyZoll_LittleWalk);
	};
};
...
{
	AI_Output			(other, self,"DIA_Grd_216_Dusty_Zoll_ToPsi_15_00"); //Udajemy się do obozu Bractwa.
...
{
	AI_Output				(other, self,"DIA_Grd_216_Dusty_Zoll_LittleWalk_15_00"); //Idziemy się przespacerować. A oto 100 bryłek rudy.
	if (Npc_HasItems (hero,itminugget) >= 100)
	{
		AI_Output			(self, other,"DIA_Grd_216_Dusty_Zoll_LittleWalk_13_00"); //Nic nie widziałem.

		B_GiveInvItems	(hero, self, ItMiNugget, 100);
		DIA_Grd_216_DustyZoll.permanent = 0;
		B_LogEntry			(CH1_RecruitDusty,"Udało mi się przekupić strażników przy południowej bramie!");
	...
	{
		AI_Output			(self, other,"DIA_Grd_216_Dusty_Zoll_LittleWalk_13_02"); //Myślisz, że jestem taki głupi? Tak łatwo ci nie pójdzie, mały!
		AI_StopProcessInfos	(self);
		Npc_SetTarget		(self,other);
		AI_StartState		(self,ZS_Attack,1,"");
...
{
	AI_Output (self, other,"Grd_216_Torwache_SEETHORUS_Info_13_01"); //Cieszę się, że cię widzę. Thorus chce z tobą porozmawiać.
	AI_Output (other, self,"Grd_216_Torwache_SEETHORUS_Info_15_02"); //A czego ode mnie chce?
	AI_Output (self, other,"Grd_216_Torwache_SEETHORUS_Info_13_03"); //Porozmawiaj z nim, to się dowiesz.
};
