...
func VOID Info_GorHanis_What_Info()
{
	...
	AI_Output (self, other,"Info_GorHanis_What_08_01"); //Ja? Walczę ku chwale wielkiego Śniącego!
};
...
func VOID Info_GorHanis_Arena_Info()
{
	...
	AI_Output (self, other,"Info_GorHanis_Arena_08_01"); //Zostałem wybrany przez moich mistrzów, by bronić na arenie honoru obozu na bagnie.
	AI_Output (self, other,"Info_GorHanis_Arena_08_02"); //Przyświeca mi więc wyższy cel. Walczę, by pokazać niewiernym jak wielka jest potęga Śniącego!
};
...
{
	AI_Output (other, self,"Info_GorHanis_Sleeper_15_00"); //Kim jest Śniący?
	AI_Output (self, other,"Info_GorHanis_Sleeper_08_01"); //W naszym obozie znajdziesz świętych mężów, którzy odpowiedzą ci na to pytanie znacznie lepiej niż ja.
	AI_Output (self, other,"Info_GorHanis_Sleeper_08_02"); //Powiem ci tylko tyle: Śniący będzie naszym zbawicielem. Przyprowadził nas tutaj i z jego pomocą uda się nam stąd wydostać.
	AI_Output (other, self,"Info_GorHanis_Sleeper_15_03"); //Chcesz przez to powiedzieć, że czekacie aż wasz bóg zwróci wam wolność?
	AI_Output (self, other,"Info_GorHanis_Sleeper_08_04"); //Tak! Nasze oczekiwanie wkrótce dobiegnie końca. W tej chwili przygotowujemy się do rytuału wielkiego przyzwania.
};
...
instance Info_GorHanis_Summoning (C_INFO)
{
	...
	permanent		= 0;
	description 	= "Na czym polega rytuał, który planujecie?";
};                       
...
{
	AI_Output (other, self,"Info_GorHanis_Summoning_15_00"); //Na czym polega rytuał, który planujecie?
	AI_Output (self, other,"Info_GorHanis_Summoning_08_01"); //Nasi prorocy przewidzieli, że wspólne przywołanie Śniącego jest jedyną drogą do odzyskania wolności!
	AI_Output (self, other,"Info_GorHanis_Summoning_08_02"); //Jeśli chcesz się jeszcze czegoś dowiedzieć, powinieneś udać się do naszego obozu.
};
...
instance Info_GorHanis_WayToST(C_INFO)
{
	...
	permanent		= 1;
	description 	= "Mógłbyś opisać mi drogę do waszego obozu?";
};                       
...
{
	AI_Output (other, self,"Info_GorHanis_WayToST_15_00"); //Mógłbyś opisać mi drogę do waszego obozu?
	AI_Output (self, other,"Info_GorHanis_WayToST_08_01"); //W Starym Obozie znajdziesz kilku Nowicjuszy Bractwa, którzy chętnie wskażą ci drogę do obozu na bagnie. Znajdź któregoś z nich i porozmawiaj z nim!
};
...
instance Info_GorHanis_Charge (C_INFO)
{
	...
	permanent		= 0;
	description 	= "Wyzywam cię na pojedynek na arenie!";
};                       
...
{
	AI_Output (other, self,"Info_GorHanis_Charge_15_00"); //Wyzywam cię na pojedynek na arenie!
	AI_Output (self, other,"Info_GorHanis_Charge_08_01"); //Zabicie kogoś takiego jak ty nie przysporzy raczej chwały Śniącemu.
	AI_Output (self, other,"Info_GorHanis_Charge_08_02"); //Stanę z tobą w szranki dopiero w tedy, gdy okażesz się godnym rywalem.
	AI_Output (self, other,"Info_GorHanis_Charge_08_03"); //Ale jestem pewien, że wojownicy z Nowego Obozu nie będą mieli takich skrupułów...…
};
...
instance Info_GorHanis_ChargeGood (C_INFO)
{
	...
	permanent		= 1;
	description 	= "Czy jestem już dość silny, żeby się z tobą zmierzyć?";
};                       
...
{
	AI_Output (other, self,"Info_GorHanis_ChargeGood_15_00"); //Czy jestem już dość silny, żeby się z tobą zmierzyć?
	AI_Output (self, other,"Info_GorHanis_ChargeGood_08_01"); //Nie! Jesteś jeszcze zbyt słaby. Nie sprostasz mi w walce!
};
