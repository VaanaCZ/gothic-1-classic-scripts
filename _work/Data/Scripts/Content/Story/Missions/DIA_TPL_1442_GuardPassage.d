...
func void Info_TPL_1442_FirstWarn_Info()
{
	...
	AI_Output		(self, hero,"Info_TPL_1442_FirstWarn_13_01"); //STÓJ! Na świątynne wzgórze można wejść tylko za pozwoleniem któregoś z Guru!
	...
	if (Npc_KnowsInfo(hero, PC_Psionic_SEND))
	{
		...
		Info_Addchoice 		(Info_TPL_1442_FirstWarn,"Sam Y'Berion udzielił mi pozwolenia.",	Info_TPL_1442_FirstWarn_Condition_YBERION);  
		Info_Addchoice 		(Info_TPL_1442_FirstWarn,"Przysyła mnie Nowicjusz Lester.",	Info_TPL_1442_FirstWarn_Condition_LESTER);  
	}
	else
	{
...
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_YBERION_15_01"); //Sam Y'Berion udzielił mi pozwolenia.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_YBERION_13_02"); //Kłamcy łatwo mogą stracić język, więc uważaj co mówisz.
};

func void Info_TPL_1442_FirstWarn_Condition_LESTER ()
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_LESTER_15_01"); //Przysyła mnie Nowicjusz Lester. Chciałbym ofiarować moje usługi Y'Berionowi.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_LESTER_13_02"); //Znam Lestera. Można mu zaufać. Możesz przejść.
	Info_Clearchoices 	(Info_TPL_1442_FirstWarn);
...
{
	AI_Output 		(self, hero,"Info_TPL_1442_LastWarn_13_01"); 		//Jeszcze jeden krok, a będzie po tobie.
