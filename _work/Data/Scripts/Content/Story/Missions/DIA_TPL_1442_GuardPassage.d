...
func void Info_TPL_1442_FirstWarn_Info()
{
	...
	AI_Output		(self, hero,"Info_TPL_1442_FirstWarn_13_01"); //STÙJ! Na chrámový vrch smíš vstoupit jedinì s povolením od Guru!
	...
	if (Npc_KnowsInfo(hero, PC_Psionic_SEND))
	{
		...
		Info_Addchoice 		(Info_TPL_1442_FirstWarn,"Poslal mì novic Lester.",	Info_TPL_1442_FirstWarn_Condition_LESTER);  
	}
	else
	{
...
func void Info_TPL_1442_FirstWarn_Condition_YBERION ()
{
	...
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_YBERION_13_02"); //Lháøi mùžou pøijít snadno o své jazyky, tak si dávej lepší pozor na to, co øíkáš.
};

func void Info_TPL_1442_FirstWarn_Condition_LESTER ()
{
	AI_Output (hero, self,"Info_TPL_1442_FirstWarn_Condition_LESTER_15_01"); //Poslal mì novic Lester. Mám nabídnout Y´Berionovi své služby.
	AI_Output (self, hero,"Info_TPL_1442_FirstWarn_Condition_LESTER_13_02"); //Lester je dùvìryhodný. Znám ho. Mùžeš jít.
	Info_Clearchoices 	(Info_TPL_1442_FirstWarn);
...
{
	AI_Output 		(self, hero,"Info_TPL_1442_LastWarn_13_01"); 		//Ještì krok a je s tebou konec.
