...
INSTANCE DIA_Grd_214_Torwache_job (C_INFO)
{
	...
	permanent		= 1;
	description		= "Co tu robisz przez cały dzień?"; 
};
...
{
	AI_Output (other, self,"DIA_Grd_214_Torwache_job_15_00"); //Co tu robisz przez cały dzień?
	AI_Output (self, other,"DIA_Grd_214_Torwache_job_07_01"); //Dbam o to, by nikt nieproszony nie dostał się do zamku.
	AI_Output (self, other,"DIA_Grd_214_Torwache_job_07_02"); //Dlatego nawet nie próbuj rozrabiać, bo zrobię ci krzywdę.
};
...
{
	AI_Output (self, other,"Grd_214_Torwache_SEETHORUS_Info_07_01"); //Hej, dobrze że jesteś. Thorus chce się z tobą widzieć!
...
{
	AI_Output			(self, other,"Grd_214_Torwache_NODUSTY_Info_07_01"); //HEJ, TY!!! Chyba nie próbujesz przemycić Dusty'ego na zewnątrz, co?
	AI_Output			(other, self,"Grd_214_Torwache_NODUSTY_Info_15_02"); //Chcieliśmy tylko...
	AI_Output			(self, other,"Grd_214_Torwache_NODUSTY_Info_07_03"); //To się wam zaraz odechce!
