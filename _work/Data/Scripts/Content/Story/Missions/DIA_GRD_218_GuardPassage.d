...
FUNC VOID DIA_Grd_218_FirstIn_Info()
{
	...
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_01"); //Chcę wejść do środka.
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_02"); //Kpisz sobie ze mnie, czy co?
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_03"); //Może zapytasz Thorusa?
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_04"); //Zapytam. Jeśli łżesz, już po tobie!
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_05"); //Czy to znaczy, że mogę wejść?
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_06"); //Tak! Rusz się wreszcie!
	AI_StopProcessInfos	(self);
};
...
func void Info_Grd_218_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Grd_218_FirstWarn_Info_07_03"); //Takie łachudry jak ty nie mają wstępu do siedziby Magnatów!
