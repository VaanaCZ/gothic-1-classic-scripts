...
{
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_00"); //Stùj! Co tady dìláš?
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_01"); //Chci dovnitø.
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_02"); //To má být žert?
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_03"); //Proè se nezeptáš Thoruse?
	AI_Output (self, other,"DIA_Grd_218_FirstIn_07_04"); //Udìlám to. Jestli lžeš, jsi mrtvej!
	AI_Output (other, self,"DIA_Grd_218_FirstIn_15_05"); //Øíkáš, že mùžu dál?
...
func void Info_Grd_218_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Grd_218_FirstWarn_Info_07_01"); //STÙJ! Už ani krok!
	AI_Output (hero, self,"Info_Grd_218_FirstWarn_Info_15_02"); //Proè?
	AI_Output (self, hero,"Info_Grd_218_FirstWarn_Info_07_03"); //Rudobaronùv dùm je tabu pro takové pobudy jako ty!
