...
{	
	AI_Output (other, self,"DIA_ARTO_Hello_15_00"); //Chi sei?
	AI_Output (self, other,"DIA_ARTO_Hello_13_01"); //Sono Arto.
};
...
INSTANCE DIA_ARTO_What (C_INFO)
{
	...
	permanent	= 0;
	description = "Perché giri qui intorno?";
};                       
...
{	
	AI_Output (other, self,"DIA_ARTO_What_15_00"); //Perché ti aggiri qua intorno?
...
INSTANCE DIA_ARTO_PERM (C_INFO)
{
	...
	permanent	= 1;
	description = "Non parli molto, vero?";
};                       
...
{	
	...
	AI_Output (self, other,"DIA_ARTO_PERM_13_01"); //Già.
};
