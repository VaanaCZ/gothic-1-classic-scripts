...
func void Info_Pacho_STOP_Info()
{
	...
	AI_Output			(self, hero,"Info_Pacho_STOP_13_03"); //Nie, twoja babcia... Jasne, że ty!!!
	AI_Output			(self, hero,"Info_Pacho_STOP_13_04"); //Na twoim miejscu nie szedłbym dalej!
	AI_Output			(hero, self,"Info_Pacho_STOP_15_05"); //Dlaczego?
	AI_Output			(self, hero,"Info_Pacho_STOP_13_06"); //Widzę, że jesteś tu nowy, co?
	AI_Output			(self, hero,"Info_Pacho_STOP_13_07"); //Stary, ta droga prowadzi na ziemie Orków...
	AI_Output			(self, hero,"Info_Pacho_STOP_13_08"); //Zrobią z ciebie kotlety!
