...
FUNC VOID Info_Grd_212_FirstWarn_Info()
{
	...
	AI_Output (hero, self,"Info_Grd_212_FirstWarn_Info_15_02"); //Co się dzieje?
	AI_Output (self, hero,"Info_Grd_212_FirstWarn_Info_13_03"); //Nie wolno ci wejść do zamku bez pozwolenia. Wynoś się stąd!
...
{
	AI_Output (self, hero,"Info_Grd_212_LastWarn_13_01"); 		//Ogłuchłeś? Jeszcze jeden krok a nakarmię tobą robaki!
...
INSTANCE Info_Grd_212_Abblitzen (C_INFO)
{
	...
	permanent	= 1;
	description	= "Muszę się dostać do zamku.";
};                       
...
{
	AI_Output (other, self,"Info_Grd_212_Abblitzen_15_00"); //Muszę się dostać do zamku.
	AI_Output (self, other,"Info_Grd_212_Abblitzen_13_01"); //A to ciekawe! Bo ja MUSZĘ się wydostać z tej przeklętej kolonii!
	AI_Output (self, other,"Info_Grd_212_Abblitzen_13_02"); //Mam ciekawsze rzeczy do roboty niż pilnowanie, żeby tacy jak ty nie włóczyli się, gdzie ich nie proszono.
	AI_Output (other, self,"Info_Grd_212_Abblitzen_15_03"); //Mógłbyś mnie po prostu wpuścić...
	AI_Output (self, other,"Info_Grd_212_Abblitzen_13_04"); //Nie, nie mógłbym. To działka Thorusa.
	AI_StopProcessInfos	(self);
};
...
FUNC VOID Info_Grd_212_FirstIn_Info()
{
	...
	AI_Output (other, self,"Info_Grd_212_FirstIn_15_01"); //Spokojnie, rozmawiałem z Thorusem. Powiedział, że mogę wejść.
	AI_Output (self, other,"Info_Grd_212_FirstIn_13_02"); //Zapamiętam sobie twoją twarz, koleś. Jak zaczniesz rozrabiać, szybko się z tobą rozprawię.
	AI_StopProcessInfos	(self);
};
...
INSTANCE Info_Grd_212_Passgate (C_INFO)
{
	...
	permanent	= 1;
	description	= "Ale wciąż mogę wejść do środka?";
};                       
...
{
	AI_Output (other, self,"Info_Grd_212_Passgate_15_00"); //Ale wciąż mogę wejść do środka?
	AI_Output (self, other,"Info_Grd_212_Passgate_13_01"); //Pod warunkiem, że przestaniesz zadawać głupie pytania.
	AI_StopProcessInfos	(self);
};
