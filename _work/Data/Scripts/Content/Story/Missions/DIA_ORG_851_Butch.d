...
{
	AI_Output (other, self,"DIA_Butch_Hello_15_00"); //Cześć. Kim jesteś?
	AI_Output (self, other,"DIA_Butch_Hello_13_01"); //Nie twój interes! Nie podoba mi się twoja gęba!
	AI_StopProcessInfos	( self );
};
