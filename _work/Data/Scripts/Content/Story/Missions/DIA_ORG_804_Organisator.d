...
{
	AI_Output (self, other,"Org_804_Organisator_Greet_06_00"); //E adesso dove stai andando?
};
...
{
	AI_Output (other, self,"Org_804_Organisator_WayTo_15_00"); //Dove POSSO andare?
	AI_Output (self, other,"Org_804_Organisator_WayTo_06_01"); //Da Lares.
...
instance  Org_804_Organisator_ToLares (C_INFO)
{
	...
	permanent	= 0;
	description  = "Voglio incontrare Lares.";
};                       
...
instance  Org_804_Organisator_PERM (C_INFO)
{
	...
	permanent	= 1;
	description  = "Posso vedere Lares?";
};                       
...
{
	AI_Output (other, self,"Org_804_Organisator_PERM_15_00"); //Posso vedere Lares?
	AI_Output (self, other,"Org_804_Organisator_PERM_06_01"); //Sbrigatela con Roscoe.
	AI_StopProcessInfos	(self);
};
...
func void Info_Org_804_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Org_804_FirstWarn_Info_06_00"); //I servi di Gomez non possono entrare qui! Vattene!
