...
INSTANCE DIA_Org_876_AmSfb (C_INFO)
{
	...
	permanent	= 1;
	description = "Jsem rudaø! A mám žízeò!";
};                       
...
{	
	AI_Output (other, self,"DIA_Org_876_AmSfb_15_00"); //Jsem rudaø! A mám žízeò!
	...
	{
		AI_Output (self, other,"DIA_Org_876_AmSfb_06_01"); //Vypadáš jako jedna z tìch špinavejch krys. Pojï dál!
	...
	{
		AI_Output (self, other,"DIA_Org_876_AmSfb_NOSFB_06_00"); //Nevypadáš jako rudaø. Takhle dovnitø nesmíš, hochu.
	};
};
...
INSTANCE DIA_Org_876_Bribe (C_INFO)
{
	...
	permanent	= 1;
	description = "Co takhle nìjakou rudu jako vstupné?";
};                       
...
{	
	AI_Output (other, self,"DIA_Org_876_Bribe_15_00"); //Co takhle nìjakou rudu jako vstupné?
	AI_Output (self, other,"DIA_Org_876_Bribe_06_01"); //Co myslíš tím 'nìjakou'?
	
	Info_ClearChoices	(DIA_Org_876_Bribe );
	Info_AddChoice		(DIA_Org_876_Bribe,"100 nugetù by mìlo staèit.",DIA_Org_876_Bribe_100Erz);
	Info_AddChoice		(DIA_Org_876_Bribe,"Co øíkáš na 50 nugetù?",DIA_Org_876_Bribe_50Erz);
	Info_AddChoice		(DIA_Org_876_Bribe,"Mám s sebou 10 nugetù.",DIA_Org_876_Bribe_10Erz);
};

func void DIA_Org_876_Bribe_10Erz()
{
	AI_Output (other, self,"DIA_Org_876_Bribe_10Erz_15_00"); //Mám s sebou 10 nugetù.
	if (Npc_HasItems (other, itminugget) >= 10)
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_10Erz_06_01"); //10 nugetù? Za to ti dovolím to zkusit znovu.
	}
	else
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_10Erz_06_02"); //Kde? Nevidím tìch 10 nugetù.
	};
...
{
	AI_Output (other, self,"DIA_Org_876_Bribe_50Erz_15_00"); //Co øíkáš na 50 nugetù?
	if (Npc_HasItems (other, itminugget) >= 50)
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_50Erz_06_01"); //To je akorát pùlka toho, èemu øíkám 'nìjakou rudu'.
	}
	else
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_50Erz_06_02"); //Kde? Nevidím tìch 50 nugetù..
	};
...
{
	AI_Output (other, self,"DIA_Org_876_Bribe_100Erz_15_00"); //100 magických nugetù by mìlo staèit.
	if (Npc_HasItems (other, itminugget) >= 100)
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_100Erz_06_01"); //Dobøe øeèeno - mùžeš dál.
		self.aivar[AIV_PASSGATE] = TRUE;	
		B_GiveInvItems	(other, self, ItMiNugget, 100);
	}
	else
	{
		AI_Output (self, other,"DIA_Org_876_Bribe_100Erz_06_02"); //To sedí. Nevidím ale, že bys mìl tolik.
	};
...
{	
	AI_Output (self, other,"DIA_Org_876_ScSld_06_00"); //Stùj! Znáš pravidla. Jen pro bandity a rudaøe!
	AI_Output (other, self,"DIA_Org_876_ScSld_15_01"); //Pokoušíš se mì zastavit?
	AI_Output (self, other,"DIA_Org_876_ScSld_06_02"); //Ne... tak pojï...
	self.aivar[AIV_PASSGATE] = TRUE;
};
...
{	
	AI_Output (self, other,"DIA_Org_876_ScSekte_06_00"); //Obvykle pouštím dovnitø jenom naše hochy, ale proti Bratrstvu nemùžu øíci nic.
	AI_Output (self, other,"DIA_Org_876_ScSekte_06_01"); //Obzvláš pak ne, když mají sebou nìco ke kouøení.
};
...
{	
	...
	if ( (Npc_HasItems(other,ItMiJoint_1)>0) || (Npc_HasItems(other,ItMiJoint_2)>0) || (Npc_HasItems(other,ItMiJoint_3)>0) )
	{
		...
		AI_Output (self, other,"DIA_Org_876_GibKraut_06_01"); //Buï vždycky vítán, èlovìèe.
		self.aivar[AIV_PASSGATE] = TRUE;
		Org_876_GotJoint = TRUE;
	}
	else
	{
		AI_Output (other, self,"DIA_Org_876_GibKraut_KEIN_15_00"); //Och... Poèkej. Já vlastnì nic nemám.
		AI_Output (self, other,"DIA_Org_876_GibKraut_KEIN_06_00"); //Výbornì. Mysli na mì pøíštì.
		self.aivar[AIV_PASSGATE] = TRUE;
	};
};
...
func void Info_Org_876_FirstWarn_Info()
{
	...
	AI_Output (hero, self,"Info_Org_876_FirstWarn_Info_15_01"); //No, dovnitø.
	AI_Output (self, hero,"Info_Org_876_FirstWarn_Info_06_02"); //Zapomeò na to! Silas chce v baru vidìt jenom rudaøe a bandity.
...
{
	AI_Output (self, hero,"Info_Org_876_LastWarn_06_00"); //Jsi hluchej, nebo co, pøíteli?
