...
INSTANCE Info_GornFM_WAIT (C_INFO)
{
	...
	important	= 0;	
	permanent	= 1;
	description	= "Utrzymuj pozycję! Spróbuję się trochę rozejrzeć!";
};                       
...
{
	AI_Output 			(hero,self,"Info_GornFM_WAIT_15_01"); //Utrzymuj pozycję! Spróbuję się trochę rozejrzeć!
	AI_Output 			(self,hero,"Info_GornFM_WAIT_09_02"); //Dobra. Zaczekam przy wejściu do kopalni i postaram się, żeby nikt nie zaszedł nas od tyłu!
...
INSTANCE Info_GornFM_FOLLOW (C_INFO)
{
	...
	important	= 0;	
	permanent	= 1;
	description	= "Chodź ze mną, potrzebuję twojej pomocy.";
};                       
...
{
	AI_Output 			(hero,self,"Info_GornFM_FOLLOW_15_01"); //Chodź ze mną, potrzebuję twojej pomocy.
	AI_Output 			(self,hero,"Info_GornFM_FOLLOW_09_02"); //Nareszcie coś się dzieje! Idź przodem, pójdę za tobą.
