...
{
	AI_Output (other,self,"Info_GRD_276_Tips_15_00"); //Cześć, jestem tu nowy.
	AI_Output (self,other,"Info_GRD_276_Tips_07_01"); //To świetnie.
};
...
FUNC VOID Info_GRD_276_Bla_Info()
{
	...
	AI_Output (self,other,"Info_GRD_276_Bla_07_01"); //Nie, Nowy! Stary Obóz leży pod mostem.
	AI_StopProcessInfos(self);
};
