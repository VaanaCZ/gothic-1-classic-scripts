...
func void Info_Grd_213_FirstWarn_Info()
{
	...
	AI_Output (self, hero,"Info_Grd_213_FirstWarn_Info_07_01"); //STÙJ!
	AI_Output (hero, self,"Info_Grd_213_FirstWarn_Info_15_02"); //Co se dìje?
...
{
	AI_Output (self, hero,"Info_Grd_213_LastWarn_07_01"); 		//Jsi hluchý? Ještì krok a je z tebe potrava pro èervy!
...
{
	AI_Output (self, other,"Grd_213_Torwache_WELCOME_Info_07_01"); //Slyšel jsem, že jsi jedním z nás? Na nìkoho, kdo tady není dlouho, to není špatné.
};
...
INSTANCE Info_Grd_213_Abblitzen (C_INFO)
{
	...
	permanent	= 1;
	description	= "Trochu života do toho umírání! Jako kdyby nìkdo...";
};                       
...
{
	AI_Output (other, self,"Info_Grd_213_Abblitzen_15_00"); //Víš, mìl bys do života vnést trochu víc vzrušení. Jako tøeba vpustit nìkoho na hrad.
	AI_Output (self, other,"Info_Grd_213_Abblitzen_07_01"); //Vzrušení? To není špatný nápad - už dlouho jsem nevyrazil nìkoho, jako jsi ty!
	AI_StopProcessInfos	(self);
};
...
{
	AI_Output (other, self,"Info_Grd_213_Passgate_15_00"); //Hej, jsi v poøádku?
	AI_Output (self, other,"Info_Grd_213_Passgate_07_01"); //Moc se tady nemotej - bìž dovnitø.
	AI_StopProcessInfos	(self);
};
