...
{
	AI_Output (self, other,"DIA_SLD_761_Soeldner_INTRO_INFO_03_01"); //Cosa ci fai dalle parti della miniera?
};
...
instance DIA_SLD_761_Soeldner_EXIT_1 (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Ho ancora delle cose da fare.";
};
...
{
	AI_Output (other, self,"DIA_SLD_761_Soeldner_EXIT_1_INFO_15_01"); //Ho ancora delle cose da fare.
	AI_Output (self, other,"DIA_SLD_761_Soeldner_EXIT_1_INFO_03_02");//Lo penso anch'io.
...
instance DIA_SLD_761_Soeldner_UMSEHEN (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Volevo solo dare un'occhiata al campo.";
};
...
instance DIA_SLD_761_Soeldner_INMINE (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Volevo solo vedere la miniera.";
};
...
instance DIA_SLD_761_Soeldner_Bribe (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Non posso farci nulla?";
};
...
{  
	AI_Output (other, self,"DIA_SLD_761_Soeldner_Bribe_INFO_15_01");//Non posso farci nulla?
