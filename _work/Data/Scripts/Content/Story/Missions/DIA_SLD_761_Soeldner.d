...
instance DIA_SLD_761_Soeldner_EXIT_1 (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Mam jeszcze kilka rzeczy do załatwienia.";
};
...
{
	AI_Output (other, self,"DIA_SLD_761_Soeldner_EXIT_1_INFO_15_01"); //Mam jeszcze kilka rzeczy do załatwienia.
	AI_Output (self, other,"DIA_SLD_761_Soeldner_EXIT_1_INFO_03_02");//Tak też myślałem.
...
instance DIA_SLD_761_Soeldner_EXIT_2 (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description 	= "Najlepiej będzie, jak już sobie pójdę.";
};
...
{
	AI_Output (other, self,"DIA_SLD_761_Soeldner_EXIT_2_INFO_15_01"); //Najlepiej będzie, jak już sobie pójdę.
	AI_Output (self, other,"DIA_SLD_761_Soeldner_EXIT_2_INFO_03_02");//W porządku.
	AI_StopProcessInfos	( self );
};
...
instance DIA_SLD_761_Soeldner_UMSEHEN (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Chciałem się trochę rozejrzeć po Obozie.";
};
...
{  
	AI_Output (other, self,"DIA_SLD_761_Soeldner_UMSEHEN_INFO_15_01"); //Chciałem się trochę rozejrzeć po Obozie.
...
instance DIA_SLD_761_Soeldner_INMINE (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Chciałem tylko obejrzeć kopalnię.";
};
...
{
	AI_Output (other, self,"DIA_SLD_761_Soeldner_INMINE_INFO_15_01");//Chciałem tylko obejrzeć kopalnię.
	AI_Output (self, other,"DIA_SLD_761_Soeldner_INMINE_INFO_03_02");//Jak widzisz, kopalnia jest zamknięta. Nie ma tu nic ciekawego do oglądania.
...
instance DIA_SLD_761_Soeldner_Bribe (C_INFO)
{
	...
	important		= 0;
	permanent		= 0;
	description 	= "Może się jakoś dogadamy?";
};
...
{  
	AI_Output (other, self,"DIA_SLD_761_Soeldner_Bribe_INFO_15_01");//Może się jakoś dogadamy?
	AI_Output (self, other,"DIA_SLD_761_Soeldner_Bribe_INFO_03_02");//A o czym tu niby gadać?
	AI_Output (self, other,"DIA_SLD_761_Soeldner_Bribe_INFO_03_03");//Sekundę, jeśli próbujesz mnie przekupić, to trafiłeś na niewłaściwego człowieka.
	AI_Output (other, self,"DIA_SLD_761_Soeldner_Bribe_INFO_15_04");//Nie próbuję nikogo przekupić. Pomyślałem tylko...
	AI_Output (other, self,"DIA_SLD_761_Soeldner_Bribe_INFO_15_05");//Lepiej już sobie pójdę.
	AI_StopProcessInfos	(self); 
};
