...
{
	AI_Output (other, self,"DIA_845_Hello_15_00"); //Cosa stai facendo?
	AI_Output (self, other,"DIA_845_Hello_13_01"); //Lavoro per il Signore del Riso.
	
	var C_NPC Lefty; Lefty = Hlp_GetNpc (Org_844_Lefty);
	if (!Npc_IsDead(Lefty))
	{
		AI_Output (self, other,"DIA_845_Hello_13_02"); //Se ti serve qualcosa, chiedi a Lefty.
	};
};
