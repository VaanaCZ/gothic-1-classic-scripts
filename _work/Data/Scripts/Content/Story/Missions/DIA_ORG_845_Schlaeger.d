...
FUNC VOID DIA_845_Hello_Info()
{
	...
	AI_Output (self, other,"DIA_845_Hello_13_01"); //Pracuję dla Ryżowego Księcia.
	
	var C_NPC Lefty; Lefty = Hlp_GetNpc (Org_844_Lefty);
	if (!Npc_IsDead(Lefty))
	{
		AI_Output (self, other,"DIA_845_Hello_13_02"); //Jakbyś czegoś potrzebował, zapytaj Lewusa.
	};
};
