...
const string KapWechsel_1			= "Rozdział 1"					;
const string KapWechsel_1_Text		= "Witamy w Kolonii!"			;
const string KapWechsel_2			= "Rozdział 2"					;
const string KapWechsel_2_Text		= "Gniazdo pełzaczy"			;
const string KapWechsel_3			= "Rozdział 3"					;
const string KapWechsel_3_Text		= "Starożytna magia"			;
const string KapWechsel_4			= "Rozdział 4"					;
const string KapWechsel_4_Text		= "Xardas"						;
const string KapWechsel_5			= "Rozdział 5"					;
const string KapWechsel_5_Text		= "Strażnicy portalu" 			;
const string KapWechsel_6			= "Rozdział 6"					;
const string KapWechsel_6_Text		= "Leże Śniącego"				;
