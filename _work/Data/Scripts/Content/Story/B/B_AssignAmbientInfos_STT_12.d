...
FUNC VOID Info_Stt_12_EinerVonEuchWerden_Info()
{
	...
	AI_Output(self,other,"Info_Stt_12_EinerVonEuchWerden_12_02"); //Solo la metà di coloro che hanno provato sono stati accettati.
	AI_Output(other,self,"Info_Stt_12_EinerVonEuchWerden_15_03"); //Cosa è successo agli altri?
...
{
	AI_Output(other,self,"Info_Stt_12_WichtigePersonen_15_00"); //Chi è il capo, qui?
	AI_Output(self,other,"Info_Stt_12_WichtigePersonen_12_01"); //Diego è alla testa delle Ombre, ma è Thorus che decide chi può incontrare Gomez.
...
INSTANCE Info_Stt_12_DasLager(C_INFO)
{
	...
	permanent	= 1;
	description = "Cosa offre questo campo?";
};                       
...
{
	AI_Output(other,self,"Info_Stt_12_DasLager_15_00"); //Cosa offre questo campo?
	AI_Output(self,other,"Info_Stt_12_DasLager_12_01"); //Farai meglio a chiederlo a i minatori. Tanto non hanno nulla da fare tutto il giorno!
};
...
{
	AI_Output(other,self,"Info_Stt_12_DieLage_15_00"); //Allora, come va?
	AI_Output(self,other,"Info_Stt_12_DieLage_12_01"); //Che diavolo vuoi?
};
