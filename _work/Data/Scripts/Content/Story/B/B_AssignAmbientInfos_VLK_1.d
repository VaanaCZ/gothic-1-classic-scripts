...
INSTANCE Info_Vlk_1_EinerVonEuchWerden (C_INFO) // E1
{
	...
	permanent	= 1;
	description = "Jak mogę zostać członkiem waszego obozu?";
};                       
...
{
	AI_Output(other,self,"Info_Vlk_1_EinerVonEuchWerden_15_00"); //Jak mogę zostać członkiem waszego obozu?
	AI_Output(self,other,"Info_Vlk_1_EinerVonEuchWerden_01_01"); //To proste. Złap jakiś kilof i złaź do kopalni. Pół wydobytej przez ciebie rudy pójdzie na ochronę, drugie pół powinno ci wystarczyć na przetrwanie.
	AI_Output(self,other,"Info_Vlk_1_EinerVonEuchWerden_01_02"); //Cena, którą Gomez każe sobie płacić za jego dostawy to zdzierstwo, ale chyba lepsze to niż ryżowa dieta, serwowana wszystkim w Nowym Obozie.
};
...
FUNC VOID Info_Vlk_1_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_Vlk_1_WichtigePersonen_01_01"); //Magnaci. To oni organizują wymianę rudy z królem. Im jesteś ważniejszy, tym większą dostajesz dolę.
};
...
INSTANCE Info_Vlk_1_DasLager(C_INFO)
{
	...
	permanent	= 1;
	description = "Jest tu coś ciekawszego do oglądania niż te chaty?";
};                       
...
{
	AI_Output(other,self,"Info_Vlk_1_DasLager_15_00"); //Jest tu coś ciekawszego do oglądania niż te chaty?
	AI_Output(self,other,"Info_Vlk_1_DasLager_01_01"); //Cóż, wieczorem można zajrzeć na arenę, popatrzeć, jak Strażnicy gruchoczą sobie kości.
	AI_Output(self,other,"Info_Vlk_1_DasLager_01_02"); //Piękny widok. Wart każdej ceny.
};
...
FUNC VOID Info_Vlk_1_DieLage_Info()
{
	...
	AI_Output(self,other,"Info_Vlk_1_DieLage_01_01"); //Spędziłem ostatnie dwa tygodnie pracując w kopalni. Teraz chcę wreszcie odpocząć, więc zejdź mi z oczu.
};
