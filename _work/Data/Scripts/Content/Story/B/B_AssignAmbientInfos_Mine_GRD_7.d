...
FUNC VOID Info_Mine_Grd_7_Mine_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Grd_7_Mine_07_01"); //Kopáèi rubou rudu a my je chráníme pøed èervy.
...
FUNC VOID Info_Mine_Grd_7_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Grd_7_WichtigePersonen_07_01"); //Ian a Asghan. Když nìco chceš, mìl bys jim to øíci.
...
{
	AI_Output(other,self,"Info_Mine_Grd_7_Minecrawler_15_00"); //Co si myslíš o èervech?
	AI_Output(self,other,"Info_Mine_Grd_7_Minecrawler_07_01"); //Spousta by jich mìla být vyhlazena, pokud se ptáš mì!
