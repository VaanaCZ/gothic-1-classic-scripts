	...
	{	
		if (typ.lp >= LP_cost)
		{
			...
			{	
				...
				PrintScreen	("Impara: armi a una mano", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_2H)
			{
				...
				PrintScreen	("Impara: armi a due mani", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen	("Impara: tirare con l'arco", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen	("Impara: usare la balestra", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_PICKLOCK)
			{
				...
				PrintScreen	("Impara: forzare le serrature", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
