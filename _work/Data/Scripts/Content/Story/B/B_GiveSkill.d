	...
	{	
		if (typ.lp >= LP_cost)
		{
			...
			{	
				...
				PrintScreen	("Nauèil ses: bojovat s jednoruèními zbranìmi", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_2H)
			{
				...
				PrintScreen	("Nauèil ses: bojovat s obouruèními zbranìmi", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen	("Nauèil ses: støílet z luku", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen	("Nauèil ses: støílet ze samostøílu", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_PICKLOCK)
			{
				...
				PrintScreen	("Nauèil ses: otevírat zámky", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
