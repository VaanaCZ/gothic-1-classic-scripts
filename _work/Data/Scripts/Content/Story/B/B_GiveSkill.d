	...
	{	
		if (typ.lp >= LP_cost)
		{
			...
			{	
				...
				PrintScreen	("Aprender: combate con armas de una mano", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_2H)
			{
				...
				PrintScreen	("Aprender: combate con armas de dos manos", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen	("Aprender: tiro con arco", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen	("Aprender: tiro con ballesta", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			...
			else if (tal == NPC_TALENT_PICKPOCKET)
			{
				...
				PrintScreen	("Aprender: hurto", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			...
			else if (tal == NPC_TALENT_SNEAK)
			{
				...
				PrintScreen	("Aprender: sigilo", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			...
			else if (tal == NPC_TALENT_FIREMASTER)
			{
				...
				PrintScreen	("Aprender: maestro de fuego", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if (tal == NPC_TALENT_ACROBAT)
			{
				Npc_SetTalentSkill(typ, NPC_TALENT_ACROBAT, NEW_Wert);
				PrintScreen	("Aprender: acrobacia", -1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else
			{
