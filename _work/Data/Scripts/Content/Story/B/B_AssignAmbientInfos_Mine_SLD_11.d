...
INSTANCE Info_Mine_Sld_11_EinerVonEuchWerden (C_INFO) // E1
{
	...
	permanent	= 1;
	description = "Come posso unirmi a voi?";
};                       
...
FUNC VOID Info_Mine_Sld_11_EinerVonEuchWerden_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Sld_11_EinerVonEuchWerden_011_02"); //Vai a provare il tuo valore da qualche parte, così forse ti sarà concesso di servire nella Buca.
};
...
{
	AI_Output(other,self,"Info_Mine_Sld_11_WichtigePersonen_15_00"); //Chi dà gli ordini, qui?
	AI_Output(self,other,"Info_Mine_Sld_11_WichtigePersonen_011_01"); //Nella Buca, tutti fanno ciò che dice Okyl. Lui conosce tutti i pezzi grossi del campo.
...
INSTANCE Info_Mine_Sld_11_DasLager(C_INFO)
{
	...
	permanent	= 1;
	description = "Ci sono novità importanti?";
};                       
...
{
	AI_Output(other,self,"Info_Mine_Sld_11_DasLager_15_00"); //Ci sono novità importanti?
	...
	AI_Output(self,other,"Info_Mine_Sld_11_DasLager_011_02"); //Già! E ancora di più se cercherai di entrare nella miniera o attraversare il cancello senza permesso.
};
...
{
	AI_Output(other,self,"Info_Mine_Sld_11_DieLage_15_00"); //Come va?
	AI_Output(self,other,"Info_Mine_Sld_11_DieLage_011_01"); //Tutto tranquillo. Un po' troppo, per i miei gusti.
};
