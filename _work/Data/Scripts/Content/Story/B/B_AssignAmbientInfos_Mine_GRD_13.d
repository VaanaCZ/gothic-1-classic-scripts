...
{
	AI_Output(other,self,"Info_Mine_Grd_13_Mine_15_00"); //Co się dzieje w kopalni?
...
{
	AI_Output(other,self,"Info_Mine_Grd_13_WichtigePersonen_15_00"); //Kto tu rządzi?
	AI_Output(self,other,"Info_Mine_Grd_13_WichtigePersonen_13_01"); //Asghan jest tu szefem, ale lepiej nie zawracaj mu głowy. Takimi jak ty zajmuje się Ian.
};
...
{
	AI_Output(other,self,"Info_Mine_Grd_13_DasLager_15_00"); //Opowiedz mi o pełzaczach.
	AI_Output(self,other,"Info_Mine_Grd_13_DasLager_13_01"); //Bractwo płaci Staremu Obozowi bagiennym zielem za prawo do polowania na pełzacze w kopalni.
...
FUNC VOID Info_Mine_Grd_13_DieLage_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Grd_13_DieLage_13_01"); //Ach... Od wieków nie brałem udziału w żadnej rozróbie.
