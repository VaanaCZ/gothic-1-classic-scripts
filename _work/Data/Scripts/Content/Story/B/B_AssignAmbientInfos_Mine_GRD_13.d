...
{
	AI_Output(other,self,"Info_Mine_Grd_13_Mine_15_00"); //Co se v tom dole dìje?
	AI_Output(self,other,"Info_Mine_Grd_13_Mine_13_01"); //Tenhle dùl je srdce Starého tábora. Žádný dùl, žádná ruda. Žádná ruda, žádné zboží. Chápeš?
};
...
FUNC VOID Info_Mine_Grd_13_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Grd_13_WichtigePersonen_13_01"); //Asghan je náš šéf. Ale ty ho nech na pokoji. Ian je z tìch, co si to s takovými, jako jsi ty, vyøídí.
};
...
INSTANCE Info_Mine_Grd_13_DasLager(C_INFO)
{
	...
	permanent	= 1;
	description = "Øekni mi nìco o èervech.";
};                       
...
{
	AI_Output(other,self,"Info_Mine_Grd_13_DasLager_15_00"); //Øekni mi nìco o èervech.
	AI_Output(self,other,"Info_Mine_Grd_13_DasLager_13_01"); //Bratrstvo zaplatilo Starému táboru drogou z bažin, a tak je nechají v dolech lovit èervy.
