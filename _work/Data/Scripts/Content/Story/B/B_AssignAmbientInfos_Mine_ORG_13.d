...
INSTANCE Info_Mine_Org_13_Mine (C_INFO) // E1
{
	...
	permanent	= 1;
	description = "Opowiedz mi coś o tym obozie.";
};                       
...
{
	AI_Output(other,self,"Info_Mine_Org_13_Mine_15_00"); //Opowiedz mi coś o tym obozie.
	AI_Output(self,other,"Info_Mine_Org_13_Mine_13_01"); //Ta dziura w ziemi pomoże nam się stąd wydostać. Jak tylko uzbieramy dość rudy, będziemy mieli gdzieś Stary Obóz.
...
{
	AI_Output(other,self,"Info_Mine_Org_13_WichtigePersonen_15_00"); //Kto tu rządzi?
...
{
	AI_Output(other,self,"Info_Mine_Org_13_DieLage_15_00"); //Dobrze się czujesz?
	AI_Output(self,other,"Info_Mine_Org_13_DieLage_13_01");//Nie gorzej niż wczoraj.
};
