...
{
	AI_Output(other,self,"Info_Mine_Grd_6_Mine_15_00"); //Co se v tom dole dìje?
	AI_Output(self,other,"Info_Mine_Grd_6_Mine_06_01"); //Kopáèi rubou rudu a pokud ne, dostanou nakládaèku!
...
FUNC VOID Info_Mine_Grd_6_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_Mine_Grd_6_WichtigePersonen_06_01"); //Asghan je náš šéf, ale Ian se stará o vìci jako jsou kopáèi a ruda.
...
{
	AI_Output(other,self,"Info_Mine_Grd_6_Minecrawler_15_00"); //Øekni mi nìco o èervech.
	AI_Output(self,other,"Info_Mine_Grd_6_Minecrawler_06_01"); //Ty bestie pøedstavují jenom problémy. Nevím, co nám pøidìlává víc práce, jestli ty potvory nebo kopáèi.
