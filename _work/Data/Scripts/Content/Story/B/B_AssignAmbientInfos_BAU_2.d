...
INSTANCE Info_Bau_2_WichtigePersonen(C_INFO)
{
	...
	permanent	= 1;
	description = "Pracujesz na polach ryżowych z własnej woli?";
};                       
...
{
	AI_Output(other,self,"Info_Bau_2_WichtigePersonen_15_00"); //Pracujesz na polach ryżowych z własnej woli?
	AI_Output(self,other,"Info_Bau_2_WichtigePersonen_02_01"); //Jasne! Lepsze to, niż zostać ZMUSZONYM do pracy przez oprychów Ryżowego Księcia!
...
{
	AI_Output(other,self,"Info_Bau_2_DasLager_15_00"); //Co możesz mi powiedzieć o Obozie?
	AI_Output(self,other,"Info_Bau_2_DasLager_02_01"); //Niełatwo się tu żyje. Najemnicy Lee i magowie są w porządku, ale Szkodniki dają się wszystkim we znaki!
...
{
	AI_Output(other,self,"Info_Bau_2_DieLage_15_00"); //Co słychać?
	AI_Output(self,other,"Info_Bau_2_DieLage_02_01"); //Czego chcesz? Przysłał cię Ryżowy Książe? Pracuję najlepiej jak potrafię!
	AI_Output(other,self,"Info_Bau_2_DieLage_15_02"); //Nikt mnie nie przysłał! Chcę po prostu porozmawiać!
	var C_NPC Ricelord;			Ricelord	= Hlp_GetNpc(Bau_900_Ricelord);
	Ricelord.aivar[AIV_FINDABLE] = TRUE;	
};
...
{
	AI_Output(other,self,"Info_Bau_2_Wasser_15_00"); //Przysyła mnie Lewus. Przyniosłem ci wodę.
	if (Npc_HasItems(other, ItFo_Potion_Water_01)>=1)
	{
		AI_Output			(self,other,"Info_Bau_2_Wasser_02_01"); //O, dzięki. Umieram z pragnienia!
	...
	{
		AI_Output(self,other,"Info_Bau_2_Wasser_NOWATER_02_00"); //Woda! Hej, człowieku! Nic nie zostało! Tylko mi nie mów, że znowu wszyscy się napili, oprócz mnie!
	};
};
