...
{
	AI_Output(other,self,"Info_FindNPC_ST_CorAngar_15_00"); //Dove si trova Cor Angar?
...
{
	AI_Output(other,self,"Info_FindNPC_ST_CorKalom_15_00"); //Dove si trova Cor Kalom?
...
{
	AI_Output(other,self,"Info_FindNPC_ST_YBerion_15_00"); //Dove si trova Y'Berion?
	...
	else
	{
		if (self.guild == GIL_NOV)
		{
			if (self.voice == 2)
			{
				AI_Output(self,other,"Info_FindNPC_ST_YBerion_02_01"); //L'Illuminato vive isolato alle pendici della collina del tempio ed esce solo per le occasioni speciali.
			}
			else if (self.voice == 3)
			{
				AI_Output(self,other,"Info_FindNPC_ST_YBerion_03_01"); //L'Illuminato vive isolato alle pendici della collina del tempio ed esce solo per le occasioni speciali.
			}
			else if (self.voice == 5)
			{
				AI_Output(self,other,"Info_FindNPC_ST_YBerion_05_01"); //L'Illuminato vive isolato alle pendici della collina del tempio ed esce solo per le occasioni speciali.
			};
		}
		else if (self.guild == GIL_TPL) 
		{
			if (self.voice == 8)
			{
				AI_Output(self,other,"Info_FindNPC_ST_YBerion_08_01"); //L'Illuminato vive isolato alle pendici della collina del tempio ed esce solo per le occasioni speciali.
			}
			else if (self.voice == 13)
			{
				AI_Output(self,other,"Info_FindNPC_ST_YBerion_13_01"); //L'Illuminato vive isolato alle pendici della collina del tempio ed esce solo per le occasioni speciali.
			};
		};
	};
