...
const int	XP_PER_LEVEL_UNCONSCIOUS	= 5;	// Erfahrungspunkte fьr das Besiegen eines Gegners (pro Level Gegners)
const int	XP_PER_LEVEL_DEAD			= 10;	// Erfahrungspunkte fьr das Tцten eines Gegners (pro Level Gegners)
...
func void B_DeathXP()
{
	...
	&&	Npc_WasInState(self, ZS_Unconscious)
	{
		...
		// SN: keine XP fьr Finishing-Move!!!
	}
	else
	{
...
func void B_UnconciousXP()
{
	...
	//-------- Erfahrung nur beim ersten Sieg ьber Menschen --------
	if	!C_NpcIsHuman(self)
