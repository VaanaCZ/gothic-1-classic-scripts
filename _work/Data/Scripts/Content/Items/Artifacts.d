...
//mag_circle 			= 	4;   //SN: Teleport-Spells müssen auch ohne Circle sprechbar sein!
	...
	description			= 	"Teletrasporto ai Maghi del Fuoco";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
//mag_circle 			= 	4;   //SN: Teleport-Spells müssen auch ohne Circle sprechbar sein!
	...
	description			= 	"Teletrasporto ai Maghi dell'Acqua";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArRuneTeleport3 (C_Item)
{
	...
	description			=	"Teletrasporto al Negromante";	//blaue Rune
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport3 (C_Item)
{
	...
	description			=	"Teletrasporto al Negromante";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport4 (C_Item)
{
	...
	description			= 	"Incantesimo di teletrasporto degli orchi";
...
//mag_circle 			= 	4;   //SN: Teleport-Spells müssen auch ohne Circle sprechbar sein!
	...
	description			=	"Teletrasporto a Campo Palude";	//lila Rune
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport5 (C_Item)
{
	...
	description			=	"Teletrasporto a Campo Palude";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTrfBloodfly (C_Item)
{
	...
	description			=	"Trasformazione in mosca vampiro";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfCrawler (C_Item)
{
	...
	description			=	"Trasformazione in pidocchio delle miniere";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfLurker (C_Item)
{
	...
	description			=	"Trasformazione in imboscatore";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfMeatbug (C_Item)
{
	...
	description			=	"Trasformazione in scarafaggio";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfMolerat (C_Item)
{
	...
	description			= "Trasformazione in topo talpa";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfOrcdog (C_Item)
{
	...
	description			=	"Trasformazione in cane orco";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfScavenger (C_Item)
{
	...
	description			=	"Trasformazione in saprofago";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfShadowbeast (C_Item)
{
	...
	description			=	"Trasformazione in mostro d'ombra";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfSnapper (C_Item)
{
	...
	description			=	"Trasformazione in laceratore";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfWaran (C_Item)
{
	...
	description			= "Trasformazione in lucertola";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfWolf (C_Item)
{
	...
	description			= "Trasformazione in lupo";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArRuneIceCube (C_Item)
{
	...
	description			=	"Blocco di ghiaccio";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollSummonSkeletons (C_Item)
{
	...
	description			=	"Evoca gli scheletri";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollArmyOfDarkness (C_Item)
{
	...
	description			=	"Armata delle tenebre";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArRuneDestroyUndead (C_Item)
{
	...
	description			=	"Morte dei non-morti";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollShrink (C_Item)
{
	...
	description			=	"Rimpicciolisci mostro";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
