...
INSTANCE ItMi_Amulet_Psi_01(C_Item)
{
	...
	description		= "Signo de la Hermandad";
	//TEXT[0]			= "";
	//TEXT[2]			= "";
	////COUNT[2]		= ;
	//TEXT[3] 		= "";
...
INSTANCE  Schutzamulett_Feuer(C_Item)
{
	...
	description		= "Amuleto de las Llamas";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Waffen(C_Item)
{
	...
	description		= "Amuleto de Armadura";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie_Feuer(C_ITEM)
{
	...
	description		= "Amuleto de Purificación";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Fire;
	COUNT[2]		= 10;
		...
		INSTANCE  Schutzamulett_Waffen_Geschosse(C_ITEM)
{
	...
	description		= "Amuleto de Piel de Piedra";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	...
	INSTANCE  Gewandtheitsamulett2(C_Item)
{
	...
	description		= "Amuleto de Destreza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE  Amulett_der_Macht(C_Item)
{
	...
	description		= "Amuleto de Poderío";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
