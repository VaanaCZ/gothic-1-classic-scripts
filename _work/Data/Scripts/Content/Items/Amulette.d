...
INSTANCE ItMi_Amulet_Psi_01(C_Item)
{
	...
	description		= "Simbolo della Fratellanza";
	//TEXT[0]			= "";
	//TEXT[2]			= "";
	////COUNT[2]		= ;
	//TEXT[3] 		= "";
	...
	INSTANCE  Schutzamulett_Waffen(C_Item)
{
	...
	description		= "Amuleto dell'armatura";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Geschosse(C_ITEM)
{
	...
	description		= "Amuleto pelle di corteccia";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie_Feuer(C_ITEM)
{
	...
	description		= "Amuleto di purificazione";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Fire;
	COUNT[2]		= 10;
		...
		INSTANCE  Schutzamulett_Waffen_Geschosse(C_ITEM)
{
	...
	description		= "Amuleto pelle di pietra";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	...
	INSTANCE  Schutzamulett_Total(C_ITEM)
{
	...
	description		= "Amuleto pelle di metallo";
	//TEXT[0]			= "";
	...
	INSTANCE  Gewandtheitsamulett2(C_Item)
{
	...
	description		= "Amuleto di destrezza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE  Staerkeamulett(C_Item)
{
	...
	description		= "Amuleto di potenza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE  Lebensamulett(C_Item)
{
	...
	description		= "Amuleto di forza vitale";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE  Amulett_der_Macht(C_Item)
{
	...
	description		= "Amuleto di grandezza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
