	...
	instance Schutzring_Feuer1(C_Item)
{
	...
	description		= "Anillo de protección contra llamas";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Feuer2(C_Item)
{
	...
	description		= "Protección contra fuego";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Fire;
	...
	INSTANCE Schutzring_Magie1(C_ITEM)
{
	...
	description		= "Anillo de Poder Espiritual";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Magie1_Fire1(C_ITEM)
{
	...
	description		= "Anillo de Purificación";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Geschosse1_Waffen1(C_ITEM)
{
	...
	description		= "Anillo de lo Inquebrantable";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Geschosse2_Waffen2(C_ITEM)
{
	...
	description		= "Anillo de Acusación";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Total1(C_ITEM)
{
	...
	description		= "Anillo Menor de lo Invencible";
	//TEXT[0]			= "";
	...
	INSTANCE Schutzring_Total2(C_ITEM)
{
	...
	description		= "Anillo Mayor de lo Invencible";
	//TEXT[0]			= "";
	TEXT[1]			= NAME_Prot_Magic;
	COUNT[1]		= 3;
	TEXT[2]			= NAME_Prot_Fire;
		...
		INSTANCE Ring_des_Geschicks(C_Item)
{
	...
	description		= "Anillo Menor de Destreza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Ring_des_Geschicks2(C_Item)
{
	...
	description		= "Anillo Mayor de Destreza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE Ring_des_Lebens2(C_Item)
{
	...
	description		= "Anillo Mayor de Vida";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
	...
	INSTANCE Machtring(C_Item)
{
	...
	description		= "Anillo de Poder del Guerrero";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Str;
