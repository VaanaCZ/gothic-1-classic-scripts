	...
	INSTANCE Schutzring_Magie1(C_ITEM)
{
	...
	description		= "Pierścień siły duchowej";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Magie1_Fire1(C_ITEM)
{
	...
	description		= "Pierścień oczyszczenia";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Magie2_Fire2(C_ITEM)
{
	...
	description		= "Pierścień niezwyciężoności";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Geschosse1_Waffen1(C_ITEM)
{
	...
	description		= "Pierścień wytrwałości";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Geschosse2_Waffen2(C_ITEM)
{
	...
	description		= "Pierścień niewzruszoności";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Total1(C_ITEM)
{
	...
	description		= "Pomniejszy pierścień niezwyciężoności";
	//TEXT[0]			= "";
	...
	INSTANCE Schutzring_Total2(C_ITEM)
{
	...
	description		= "Większy pierścień niezwyciężoności";
	//TEXT[0]			= "";
	TEXT[1]			= NAME_Prot_Magic;
	COUNT[1]		= 3;
	TEXT[2]			= NAME_Prot_Fire;
		...
		INSTANCE Ring_des_Geschicks(C_Item)
{
	...
	description		= "Pomniejszy pierścień zwinności";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Ring_des_Geschicks2(C_Item)
{
	...
	description		= "Większy pierścień zwinności";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE Ring_des_Lebens2(C_Item)
{
	...
	description		= "Większy pierścień życia";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
	...
	INSTANCE Machtring(C_Item)
{
	...
	description		= "Pierścień siły wojownika";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Str;
