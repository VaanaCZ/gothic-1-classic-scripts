	...
	INSTANCE Schutzring_Feuer2(C_Item)
{
	...
	description		= "Ochrana pøed ohnìm";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Fire;
	...
	INSTANCE Schutzring_Waffen2(C_Item)
{
	...
	description		= "Prsten kùže z magické rudy";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Total1(C_ITEM)
{
	...
	description		= "Prsten menší nepøemožitelnosti";
	//TEXT[0]			= "";
	...
	INSTANCE Schutzring_Total2(C_ITEM)
{
	...
	description		= "Prsten vìtší nepøemožitelnosti";
	//TEXT[0]			= "";
	TEXT[1]			= NAME_Prot_Magic;
	COUNT[1]		= 3;
	TEXT[2]			= NAME_Prot_Fire;
	...
	INSTANCE Ring_des_Geschicks2(C_Item)
{
	...
	description		= "Prsten vìtší obratnosti";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE Ring_des_Lebens2(C_Item)
{
	...
	description		= "Prsten vìtšího zdraví";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
	...
	INSTANCE Machtring(C_Item)
{
	...
	description		= "Váleèníkùv prsten moci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Str;
