...
{
	name 					=	"Calzoni leggeri da minatore";
...
{
	name 					=	"Armatura leggera da guardia";
...
{
	name 					=	"Armatura pesante da guardia";
...
{
	name 					=	"Armatura pesante da barone";
...
{
	name 					=	"Armatura leggera da mercenario";
...
{
	name 					=	"Armatura pesante da mercenario";
...
{
	name 					=	"Armatura leggera da novizio";
...
{
	name 					=	"Armatura leggera da templare";
...
{
	name 					=	"Armatura pesante da templare";
...
{
	name 					=	"Antica armatura di metallo";
	...
	description				=	name;
	TEXT[0]					=	"Antica armatura fatta di metallo magico.";
	TEXT[1]					=	NAME_Prot_Edge;			COUNT[1]	= protection	[PROT_EDGE];
	TEXT[2]					=	NAME_Prot_Point;		COUNT[2]	= protection	[PROT_POINT];
	TEXT[3] 				=	NAME_Prot_Fire;			COUNT[3]	= protection	[PROT_FIRE];
	TEXT[4]					=	NAME_Prot_Magic;		COUNT[4]	= protection	[PROT_MAGIC];
...
{
	name 					=	"Armatura di metallo potenziata";
	...
	description				=	name;
	TEXT[0]					=	"Stone il fabbro è riuscito a migliorarla!";
	TEXT[1]					=	NAME_Prot_Edge;			COUNT[1]	= protection	[PROT_EDGE];
	TEXT[2]					=	NAME_Prot_Point;		COUNT[2]	= protection	[PROT_POINT];
	TEXT[3] 				=	NAME_Prot_Fire;			COUNT[3]	= protection	[PROT_FIRE];
	TEXT[4]					=	NAME_Prot_Magic;		COUNT[4]	= protection	[PROT_MAGIC];
...
{
	name 					=	"Armatura da guardia Reale";
