...
INSTANCE ItFo_Potion_Mana_01(C_Item)
{
	...
	description			= "Essenza d'energia magica";
...
INSTANCE ItFo_Potion_Mana_02(C_Item)
{
	...
	description			= "Estratto d'energia magica";
...
INSTANCE ItFo_Potion_Mana_03(C_Item)
{
	...
	description			= "Elisir d'energia magica";
...
INSTANCE ItFo_Potion_Health_01(C_Item)
{
	...
	description			= "Essenza di guarigione";
...
INSTANCE ItFo_Potion_Health_02(C_Item)
{
	...
	description			= "Estratto di guarigione";
...
INSTANCE ItFo_Potion_Health_03(C_Item)
{
	...
	description			= "Elisir di guarigione";
...
INSTANCE ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	description			= "Pozione di pidocchi di miniera";
	TEXT[0]				= "Permette di contattare il Dormiente.";
...
INSTANCE ItFo_Potion_Dex_01(C_Item)
{
	...
	description			= "Essenza di destrezza";
...
INSTANCE ItFo_Potion_Dex_02(C_Item)
{
	...
	description			= "Estratto di destrezza";
...
INSTANCE ItFo_Potion_Master_01(C_Item)
{
	...
	description			= "Pozione del potere";
...
INSTANCE ItFo_Potion_Master_02(C_Item)
{
	...
	description			= "Pozione di supremazia";
...
INSTANCE ItFo_Potion_Health_Perma_01(C_Item)
{
	...
	description			= "Essenza d'energia vitale";
...
INSTANCE ItFo_Potion_Health_Perma_02(C_Item)
{
	...
	description		= "Estratto d'energia vitale";
...
INSTANCE ItFo_Potion_Health_Perma_03(C_Item)
{
	...
	description		= "Elisir d'energia vitale";
...
INSTANCE ItFo_Potion_Mana_Perma_01(C_Item)
{
	...
	description			= "Essenza d'energia spirituale";
...
INSTANCE ItFo_Potion_Mana_Perma_02(C_Item)
{
	...
	description			= "Estratto d'energia spirituale";
...
INSTANCE ItFo_Potion_Mana_Perma_03(C_Item)
{
	...
	description			= "Elisir d'energia spirituale";
...
INSTANCE ItFo_Potion_Haste_01(C_Item)
{
	...
	description		= "Pozione d'accelerazione";
	TEXT[1]			= "Permette degli scatti a breve termine.";
...
INSTANCE ItFo_Potion_Haste_02(C_Item)
{
	...
	description		= "Pozione di velocità";
	TEXT[1]			= "Permette delle accelerazioni.";
...
INSTANCE ItFo_Potion_Haste_03(C_Item)
{
	...
	description		= "Pozione di rapidità";
	TEXT[1]			= "Permette degli scatti prolungati.";
