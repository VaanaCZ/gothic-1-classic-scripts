...
INSTANCE ItFo_Potion_Mana_03(C_Item)
{
	...
	description			= "Elixír s magickou energií";
...
INSTANCE ItFo_Potion_Health_03(C_Item)
{
	...
	description			= "Elixír s hojivou silou";
...
INSTANCE ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	description			= "Výtažek z èelisti dùlního èerva";
	TEXT[0]				= "Umožní spojení se Spáèem.";
...
INSTANCE ItFo_Potion_Master_02(C_Item)
{
	...
	description			= "Lektvar nejvyšší moci";
...
INSTANCE ItFo_Potion_Haste_01(C_Item)
{
	...
	TEXT[1]			= "Umožní hráèi krátce zrychlit bìh.";
...
INSTANCE ItFo_Potion_Haste_02(C_Item)
{
	...
	TEXT[1]			= "Umožní hráèi rychleji bìžet.";
...
INSTANCE ItFo_Potion_Haste_03(C_Item)
{
	...
	description		= "Lektvar spìchu";
	TEXT[1]			= "Umožní hráèi déle rychleji bìžet.";
