...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Podpisy";
	text[1]		= 	"Wyświetlanie tekstów dialogów."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_LOOKAROUND_INVERSE(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Odwrócone sterowanie kamerą."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Mysz";
	text[1]		= 	"Przełącza sterowanie kamerą za pomocą myszy."; // Kommentar
	// Position und Dimension	
