...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Субтитры";
	text[1]		= 	"Визуализация диалогов."; // Kommentar
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*0;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
instance MENUITEM_GAME_SUB_TITLES_CHOICE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		= 5650;		posy		=	MENU_START_Y + MENU_DY*0 + MENU_CHOICE_YPLUS;
...
INSTANCE MENUITEM_GAME_ANIMATE_WINDOWS(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
	onSelAction[0]	= SEL_ACTION_UNDEF;
	// Weitere Eigenschaften
...
instance MENUITEM_GAME_ANIMATE_WINDOWS_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5650;		posy		= MENU_START_Y + MENU_DY*1 + MENU_CHOICE_YPLUS;
...
INSTANCE MENUITEM_GAME_LOOKAROUND_INVERSE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*2;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
	onSelAction[0]	= SEL_ACTION_UNDEF;
	// Weitere Eigenschaften
...
instance MENUITEM_GAME_LOOKAROUND_INVERSE_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5650;		posy		=	MENU_START_Y + MENU_DY*2 + MENU_CHOICE_YPLUS;
	dimx = MENU_SLIDER_DX;	dimy 		= 	MENU_CHOICE_DY;
	// Aktionen
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*3;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
	onSelAction[0]	= SEL_ACTION_UNDEF;
	// Weitere Eigenschaften
...
instance MENUITEM_M_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5650;		posy		= MENU_START_Y + MENU_DY*3 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
	// Aktionen
...
INSTANCE MENUITEM_MSENSITIVITY(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	""; // Kommentar
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*4;
	dimx		=	5000;	dimy		=	750;
	// Aktionen
	onSelAction[0]	= SEL_ACTION_UNDEF;
	// Weitere Eigenschaften
...
instance MENUITEM_MSENSITIVITY_SLIDER(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5650;		posy		= MENU_START_Y + MENU_DY*4 + MENU_SLIDER_YPLUS;
...
INSTANCE MENUITEM_GAME_BLOOD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Жестокость";
	text[1]		= 	"Визуализация эффектов крови."; // Kommentar
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_DY*5;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
	onSelAction[0]	= SEL_ACTION_UNDEF;
	// Weitere Eigenschaften
...
instance MENUITEM_GAME_BLOOD_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5650;		posy		= MENU_START_Y + MENU_DY*5 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
	// Aktionen
