...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Sottotitoli";
	text[1]		= 	"Attiva i sottotitoli dei dialoghi."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Finestre animate";
	text[1]		= 	"Finestre di dialogo animate."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Inverti visuale";
	text[1]		= 	"Inverti i comandi della telecamera."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Mouse";
	text[1]		= 	"Attiva i comandi via mouse."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_BLOOD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Violenza";
	text[1]		= 	"Livello di rappresentazione del sangue."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GAME_BLOOD_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"nessuno|poco|molto|massimo";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
