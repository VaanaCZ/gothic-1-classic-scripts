...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Detalle textura";
	text[1]		= 	"Nivel de detalle de las texturas."; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Detalle modelos";
	text[1]		= 	"Nivel de detalle de los objetos."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Alcance visual en porcentaje."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Activa/desactiva los efectos de cielo."; // Kommentar
	// Position und Dimension	
