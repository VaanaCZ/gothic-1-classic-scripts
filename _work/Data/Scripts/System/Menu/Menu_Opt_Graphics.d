...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Detaily objektù";
	text[1]		= 	"Úroveò detailù objektù."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Viditelnost";
	text[1]		= "Viditelnost v hracím oknì v procentech."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Zapnout/vypnout efekty oblohy"; // Kommentar
	// Position und Dimension	
