...
{
	text[0]			=	"Dopøedu";
	text[1]			=   "Stiskem DEL zrušte stávající klávesu a stiskem ENTER zadejte novou."; // Kommentar
...
{
	text[0]			=	"Najít první nejbližší osobu";
	text[1]			=   "Stiskem DEL zrušte stávající klávesu a stiskem ENTER zadejte novou."; // Kommentar
...
INSTANCE MENU_ITEM_INP_UP(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Stisknìte požadovanou klávesu";
...
INSTANCE MENU_ITEM_CHG_KEYS_SET_DEFAULT(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Vrátí nastavení klávesnice do výchozího nastavení."; // Kommentar
...
INSTANCE MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Aktivuje alternativní nastavení."; // Kommentar
