...
{
	text[0]			=	"Avanti";
	text[1]			=   "CANC-Annulla     INVIO-Assegna un tasto."; // Kommentar
...
INSTANCE MENU_ITEM_INP_UP(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Premi il tasto desiderato.";
...
{
	text[0]		=	"Predefinito";	
	text[1]		=	"Ripristina i comandi predefiniti."; // Kommentar
...
{
	text[0]		=	"Alternativo";	
	text[1]		=	"Attiva i comandi alternativi."; // Kommentar
