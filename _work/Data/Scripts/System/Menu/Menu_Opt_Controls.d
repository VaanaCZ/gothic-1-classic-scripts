...
{
	text[0]			=	"Avanzar";
	text[1]			=   "SUPR eliminar, INTRO definir tecla."; // Kommentar
...
{
	text[0]		=	"Conf. x defecto";	
	text[1]		=	"Establece conf. por defecto del teclado."; // Kommentar
...
{
	text[0]		=	"Conf. alternat.";	
	text[1]		=	"Activa conf. alternativa del teclado."; // Kommentar
