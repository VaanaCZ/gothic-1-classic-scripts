...
INSTANCE MENUITEM_VID_DEVICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Graf. adaptér";
	text[1]		=	"Po provedení této volby je tøeba znovu spustit hru Gothic"; // Kommentar
...
INSTANCE MENUITEM_VID_RESOLUTION(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Rozlišení";
	text[1]		= "Potvrïte rozlišení stiskem ENTER."; // Kommentar
