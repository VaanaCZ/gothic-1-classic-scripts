...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[0]		= "Nová hra";
	text[1]		= "Zaèít nové dobrodružství.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Nahrát hru";
	text[1]		=	"Nahrát uloženou hru";  // Kommentar
...
instance MENUITEM_MAIN_SAVEGAME_SAVE(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Uložit hru";
	text[1]		= "Uložit rozehranou hru";  // Kommentar
...
INSTANCE MENUITEM_MAIN_RESUME(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Pokraèovat";
	text[1]		=   "Pokraèovat v rozehrané høe";  // Kommentar
...
instance MENUITEM_MAIN_OPTIONS(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Nastavení";
	text[1]		= "Nastavení hry, grafiky, zvuku a klávesnice";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ukonèit Gothic";
	text[1]		= "Opustit svìt Gothic.";  // Kommentar
