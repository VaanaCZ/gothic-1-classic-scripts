...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[0]		= "Nová hra";
	text[1]		= "Začít nové dobrodružství.";  // Kommentar
...
INSTANCE MENUITEM_MAIN_RESUME(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Pokračovat";
	text[1]		=   "Pokračovat v rozehrané hře";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ukončit Gothic";
	text[1]		= "Opustit svět Gothic.";  // Kommentar
