...
{	
	...
	// Position und Dimension	
	posx		= 4500;		posy		= MENU_START_Y + MENU_SOUND_DY*0;
...
{	
	...
	type		= MENU_ITEM_SLIDER;
	// Position und Dimension	
	posx		= 4500;		posy		= 	MENU_START_Y + MENU_SOUND_DY*1;
	dimx = MENU_SLIDER_DX; dimy	= MENU_SLIDER_DY;	
	// Aktionen
...
instance MENUITEM_AUDIO_PROVIDER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 4500;		posy		=	MENU_START_Y + MENU_SOUND_DY*3 + MENU_CHOICE_YPLUS;
...
text[0]		= "Тип звучания";
	...
	// Position und Dimension	
	posx		=	500;	posy		=	MENU_START_Y + MENU_SOUND_DY*4;
	dimx		=	3000;	dimy		=	750;
	// Aktionen
	onSelAction[0]  = SEL_ACTION_UNDEF;	
	// Weitere Einstellungen
