...
INSTANCE MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Głośność efektów dźwiękowych i mowy."; // Kommentar
...
INSTANCE MENUITEM_AUDIO_MUSICVOL(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Głośność muzyki w tle."; // Kommentar
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Muzyka";
	text[1]		= "Włącza/wyłącza muzykę w tle."; // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Źródło dźwięku";
	text[1]		= "Zmiany uaktywnią się po ponownym uruchomieniu!"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		=   "2 głośniki|Słuchawki|Surround|4 głośniki";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension	
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Pogłos";
	text[1]		= "Włącza pogłos w jaskiniach (wymaga ponownego uruchomienia)."; // Kommentar
