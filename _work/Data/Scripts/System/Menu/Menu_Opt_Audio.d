...
INSTANCE MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "–ечь";
	text[1]		= "”ровень громкости эффектов и речи."; // Kommentar
...
INSTANCE MENUITEM_AUDIO_MUSICVOL(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "‘он";
	text[1]		= "”ровень громкости фоновой музыки."; // Kommentar
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "ћузыка";
	text[1]		= "¬ключение/выключение фоновой музыки."; // Kommentar
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "ƒрайвер";
	text[1]		= "»зменени€ вступ€т в силу после повторного запуска игры!"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		=   "2 колонки|Ќаушники|ќбъемное звучание|4 колонки";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension	
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ёффект эхо";
	text[1]		= "¬ключить эффект эхо в шахтах и пещерах."; // Kommentar
