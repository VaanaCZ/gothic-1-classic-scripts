...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF) 
{
	...
	text[0]		=   "unknown";
	text[1]		=   "Slot 1 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 2 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 3 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 4 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 5 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 6 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 7 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 8 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF) 
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 9 - presser ENTRER pour sauvegarder."; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 10 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 11 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 12 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 13 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 14 - presser ENTRER pour sauvegarder."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "unknown";
	text[1]		=   "Slot 15 - presser ENTRER pour sauvegarder."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 1 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 2 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 3 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 4 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 5 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 6 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "unknown";
	text[1]		=   "Slot 7 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";	
	text[1]		=   "Slot 8 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 9 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 10 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 11 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 12 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 13 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 14 - presser ENTRER pour charger."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Slot 15 - presser ENTRER pour charger."; // Kommentar	
