...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF) 
{
	...
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 1; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 2; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 3; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 4; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 5; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 6; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 7; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 8; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF) 
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 9; pulsa INTRO para guardar."; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 10; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 11; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 12; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 13; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 14; pulsa INTRO para guardar."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 15; pulsa INTRO para guardar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 1; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 2; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 3; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 4; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 5; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 6; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Ranura 7; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";	
	text[1]		=   "Ranura 8; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 9; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 10; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 11; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 12; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 13; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 14; pulsa INTRO para cargar."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Ranura 15; pulsa INTRO para cargar."; // Kommentar	
