...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF) 
{
	...
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 1 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 2 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 3 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 4 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 5 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 6 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 7 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 8 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF) 
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 9 - Premi INVIO per salvare."; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 10 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 11 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 12 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 13 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 14 - Premi INVIO per salvare."; // Kommentar	
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF) 
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 15 - Premi INVIO per salvare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 1 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 2 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 3 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 4 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 5 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 6 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "sconosciuto";
	text[1]		=   "Posizione 7 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";	
	text[1]		=   "Posizione 8 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 9 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 10 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 11 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 12 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 13 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 14 - Premi INVIO per caricare."; // Kommentar	
...
{
	text[0]		=   "---";
	text[1]		=   "Posizione 15 - Premi INVIO per caricare."; // Kommentar	
