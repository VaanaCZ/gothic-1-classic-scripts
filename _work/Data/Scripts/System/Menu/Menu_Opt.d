...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Juego";
	text[1]		= "Modificar configuraciones de juego.";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Rendim./Calidad";
	text[1]		= "Optimizar el rendimiento y la calidad.";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "config. personaliz.#alto rendim.|calidad media|calidad alta";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
