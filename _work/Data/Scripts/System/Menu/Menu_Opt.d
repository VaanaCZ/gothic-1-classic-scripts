...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Gioco";
	text[1]		= "Modifica alcune opzioni della partita.";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Grafica";
	text[1]		= "Campo visivo, dettaglio ed effetti.";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"Video";
	text[1]		=	"Scheda video, risoluzione e luminosità.";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Audio";
	text[1]		= "Musica, dialoghi ed effetti sonori.";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Tastiera";
	text[1]		= "Impostazione della tastiera.";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Ottimizzare le prestazioni e la qualità.";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "predefinite#alte prestazioni|media qualità|alta qualità";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
