...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Gra";
	text[1]		= "Różne ustawienia dotyczące gry.";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Grafika";
	text[1]		= "Szczegółowość obrazu i efekty specjalne.";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"Obraz";
	text[1]		=	"Karta graficzna, rozdzielczość i jasność.";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Dźwięk";
	text[1]		= "Muzyka, mowa i efekty dźwiękowe.";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Dostosowanie wydajności i jakości obrazu.";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "opcje użytkownika#wydajność|średnia jakość|wysoka jakość";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
