...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Hra";
	text[1]		= "Upravit nastavení hry.";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Grafika";
	text[1]		= "Viditelnost v hracím oknì, detaily a efekty.";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"Video";
	text[1]		=	"Grafický adaptér, rozlišení a ostrost obrazu.";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zvuk";
	text[1]		= "Hudba, jazyk a zvukové efekty.";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Klávesnice";
	text[1]		= "Nastavení klávesnice.";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Optimalizovat výkon a kvalitu.";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "uživatelské nastavení#vysoký výkon|støední kvalita|vysoká kvalita";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
