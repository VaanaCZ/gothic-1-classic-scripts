...
INSTANCE spellFX_Firestorm_SPREAD	(CFx_Base_Proto)
{
		...
		//emFXCollDyn_S     		= "spellFX_Firespell_HUMANBURN";	// [Edenfeld] NSC Feuerschaden wird in der spell_params.d festgelegt, hier unnцtig, (ausser fьr Item Collisionen und _ZUSДTZLICHEN_ Effekten unabhдngig vom Feuerschaden - ja ehrlich es ist wahr!)
		emTrjTargetRange	 	= 20;
		emTrjTargetElev 		= 0;
		emTrjDynUpdateDelay		= 20000;
		emCheckCollision		= 1;
...
instance spellFX_Speed_START		(CFx_Base_Proto)			// HEAL START wird im 1. Invest-Key getriggert. Sдule aus dem Boden.
{
...
instance spellFX_Speed_ORIGIN	(CFx_Base_Proto)		// HEAL ORIGIN wird automatisch ьber emFXInvestOrigin_S getriggert. Aura um den Spieler
{
...
instance spellFX_Heal_START		(CFx_Base_Proto)			// HEAL START wird im 1. Invest-Key getriggert. Sдule aus dem Boden.
{
		visname_S 			= "MFX_Heal_Start";
		sfxID			  	= "MFX_Heal_CAST";
		sfxisambient		= 1;
...
instance spellFX_Heal_ORIGIN	(CFx_Base_Proto)		// HEAL ORIGIN wird automatisch ьber emFXInvestOrigin_S getriggert. Aura um den Spieler
{
		visname_S 			= "MFX_Heal_Invest";
		emTrjOriginNode 	= "BIP01";
		visAlpha			= 1;
...
/* INSTANCE spellFX_Stormfist_SUB(CFx_Base_Proto)		// vorrьbergehend, bis er hardcodiert nicht mehr gesucht wird
{
     	visname_S 				= "";
...
instance spellFX_Thunderspell_TARGET			(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 Head";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD1		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 R UPPERARM";
		visAlpha		= 1;
